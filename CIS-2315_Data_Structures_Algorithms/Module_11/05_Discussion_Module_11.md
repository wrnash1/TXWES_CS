# Discussion Forum: Module 11 - Dijkstra's Shortest Path
...
*   **Topic Focus:** **Dijkstra's Shortest Path** (specifically focusing on: `Single-source shortest path, priority queue, edge relaxation, negative edge weights restriction.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Dijkstra's Shortest Path in an enterprise system. Address the following:
