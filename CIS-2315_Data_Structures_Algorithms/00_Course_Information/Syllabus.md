...
### Course Syllabus: CIS-2315_Data_Structures_Algorithms - Technical Interview Readiness (LeetCode / HackerRank)
...
### Course Description
Data structures and algorithms, time and space complexity, recursion, balanced trees, heaps, graphs, sorting, and dynamic programming.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **Technical Interview Readiness (LeetCode / HackerRank)** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **Technical Interview Readiness (LeetCode / HackerRank)** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [OpenDSA Data Structures and Algorithms](https://opendsa-server.cs.vt.edu/)
    *   **Primary Video Lecture Course:** [Data Structures & Algorithms Course by Abdul Bari](https://www.youtube.com/watch?v=RBSGKlAvoiM)
    *   **Official Vendor Reference Portal:** [VisuAlgo - Data Structure Visualizations](https://visualgo.net/)
...
*   **Module 01:** Time & Space Complexity
*   **Module 02:** Singly & Doubly Linked Lists
...
*   **Module 10:** Breadth-First & Depth-First Search
*   **Module 11:** Dijkstra's Shortest Path
*   **Module 12:** Divide & Conquer
*   **Module 13:** Greedy Algorithms
*   **Module 14:** Dynamic Programming Basics
*   **Module 15:** String Algorithms & Trie
*   **Module 16:** Final Exam Prep & Certification Exam (Technical Interview Readiness (LeetCode / HackerRank))
