# Lab Activity: Module 01 - Time & Space Complexity
## Course: CIS-2315_Data_Structures_Algorithms (Technical Interview Readiness (LeetCode / HackerRank))

---

## Objective
Configure and verify systems matching the operational parameters of **Time & Space Complexity**.
...
1. **Create a loop-based script and analyze its operations count**
...
2. **Measure execution time of linear search vs binary search**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Document memory usage differences of array sizes**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
