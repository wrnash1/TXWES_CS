# Lab Activity: Module 02 - Singly & Doubly Linked Lists
## Course: CIS-2315_Data_Structures_Algorithms (Technical Interview Readiness (LeetCode / HackerRank))

---

## Objective
Configure and verify systems matching the operational parameters of **Singly & Doubly Linked Lists**.
...
1. **Implement a singly linked list class in Python/C**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Write a method to reverse a singly linked list in place**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Measure list traversal times against array indexing**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
