# Lab Activity: Module 11 - Scrum Framework Roles
## Course: CIS-3350_Software_Engineering_Agile (Professional Scrum Master (PSM I))

---

## Objective
Configure and verify systems matching the operational parameters of **Scrum Framework Roles**.
...
1. **Assign project tasks matching Scrum roles**
