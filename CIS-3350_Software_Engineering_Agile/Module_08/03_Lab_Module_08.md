# Lab Activity: Module 08 - Software Testing Levels
## Course: CIS-3350_Software_Engineering_Agile (Professional Scrum Master (PSM I))

---

## Objective
Configure and verify systems matching the operational parameters of **Software Testing Levels**.
...
1. **Write pytest unit test cases asserting function returns**
