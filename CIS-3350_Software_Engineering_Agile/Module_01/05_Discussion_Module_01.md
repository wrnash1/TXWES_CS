# Discussion Forum: Module 01 - SDLC Models
...
*   **Topic Focus:** **SDLC Models** (specifically focusing on: `Software Development Life Cycle, Waterfall model, Agile model, iterative phases, risk evaluation.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply SDLC Models in an enterprise system. Address the following:
