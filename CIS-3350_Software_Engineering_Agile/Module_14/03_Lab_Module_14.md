# Lab Activity: Module 14 - Software Security & Coding Standards
## Course: CIS-3350_Software_Engineering_Agile (Professional Scrum Master (PSM I))

---

## Objective
Configure and verify systems matching the operational parameters of **Software Security & Coding Standards**.
...
1. **Review code templates for security issues**
