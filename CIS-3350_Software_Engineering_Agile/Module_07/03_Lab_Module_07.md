# Lab Activity: Module 07 - Design Patterns (Structural & Behavioral)
## Course: CIS-3350_Software_Engineering_Agile (Professional Scrum Master (PSM I))

---

## Objective
Configure and verify systems matching the operational parameters of **Design Patterns (Structural & Behavioral)**.
...
1. **Implement Observer pattern to notify clients on data updates**
