# Discussion Forum: Module 12 - Scrum Events
...
*   **Topic Focus:** **Scrum Events** (specifically focusing on: `Sprint, Sprint Planning, Daily Scrum, Sprint Review, Sprint Retrospective, timeboxing rules.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Scrum Events in an enterprise system. Address the following:
