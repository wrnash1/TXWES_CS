...
*   **Visual:** Instructor on camera with a title card displaying: **Security Auditing Procedures**.
*   **Audio:** "Hello class! Today we are digging into a vital topic for the **ISACA Certified Information Security Manager (CISM)** exam: **Security Auditing Procedures**. If you are new to this concept, don't worry. We will break it down step-by-step. Understanding how these systems communicate and operate is fundamental for passing your certification exam and configuring systems in a real-world enterprise environment."
*   **Study Link:** [ISACA CISM / Cyber GRC Course Playlist - Security Auditing Procedures](https://www.youtube.com/playlist?list=PLbnu8t2G_vG0V7kC0V3n_nU9Y3S-4K178)

---

### [02:30 - 09:30] Conceptual Deep-Dive
*   **Visual:** Split screen showing slides and a diagram mapping the key configurations.
*   **[Alt-text: A diagram illustrating the operational relationships of Security Auditing Procedures components, highlighting data paths and connection rules.]**
*   **Audio:** "Let's review the terms you need to master for this week's unit:
    IT audit, internal audit vs external audit, audit evidence, audit trail logs, control testing.
...
*   **[Alt-text: Command line console output showing the verification runs for Security Auditing Procedures.]**
