# Lab Activity: Module 14 - Security Awareness Programs
## Course: CIS-4315_Cyber_Governance_Risk_Compliance (ISACA Certified Information Security Manager (CISM))

---

## Objective
Configure and verify systems matching the operational parameters of **Security Awareness Programs**.
...
1. **Draft a phishing simulation training slide outline**
