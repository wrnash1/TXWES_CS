# Discussion Forum: Module 13 - Vendor Risk Management
...
*   **Topic Focus:** **Vendor Risk Management** (specifically focusing on: `Third-party risk, vendor assessment, SOC 2 reports, service level agreements (SLA), security questionnaires.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Vendor Risk Management in an enterprise system. Address the following:
