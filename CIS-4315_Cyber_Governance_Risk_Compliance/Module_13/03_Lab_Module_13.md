# Lab Activity: Module 13 - Vendor Risk Management
## Course: CIS-4315_Cyber_Governance_Risk_Compliance (ISACA Certified Information Security Manager (CISM))

---

## Objective
Configure and verify systems matching the operational parameters of **Vendor Risk Management**.
...
1. **Evaluate third-party vendor security disclosures**
