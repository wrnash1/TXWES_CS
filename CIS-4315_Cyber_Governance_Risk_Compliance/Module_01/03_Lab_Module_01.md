# Lab Activity: Module 01 - Security Governance Frameworks
## Course: CIS-4315_Cyber_Governance_Risk_Compliance (ISACA Certified Information Security Manager (CISM))

---

## Objective
Configure and verify systems matching the operational parameters of **Security Governance Frameworks**.
...
1. **Map security program alignments to corporate goals**
