# Lab Activity: Module 07 - Business Impact Analysis
## Course: CIS-4315_Cyber_Governance_Risk_Compliance (ISACA Certified Information Security Manager (CISM))

---

## Objective
Configure and verify systems matching the operational parameters of **Business Impact Analysis**.
...
1. **Draft a BIA questionnaire layout**
