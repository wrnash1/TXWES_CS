# Discussion Forum: Module 03 - Risk Management Frameworks
...
*   **Topic Focus:** **Risk Management Frameworks** (specifically focusing on: `Risk management frameworks, NIST SP 800-37 (RMF), risk categorization, control selections.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Risk Management Frameworks in an enterprise system. Address the following:
