# Discussion Forum: Module 05 - Risk Assessment Methodology
...
*   **Topic Focus:** **Risk Assessment Methodology** (specifically focusing on: `Qualitative vs quantitative assessment, threats, vulnerabilities, likelihood, impact, Single Loss Expectancy (SLE), Annualized Loss Expectancy (ALE).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Risk Assessment Methodology in an enterprise system. Address the following:
