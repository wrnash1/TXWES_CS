# Lab Activity: Module 05 - Risk Assessment Methodology
## Course: CIS-4315_Cyber_Governance_Risk_Compliance (ISACA Certified Information Security Manager (CISM))

---

## Objective
Configure and verify systems matching the operational parameters of **Risk Assessment Methodology**.
...
1. **Calculate SLE (Asset Value * Exposure Factor)**
