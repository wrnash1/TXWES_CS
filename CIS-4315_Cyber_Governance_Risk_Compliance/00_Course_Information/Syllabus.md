...
### Course Syllabus: CIS-4315_Cyber_Governance_Risk_Compliance - ISACA Certified Information Security Manager (CISM)
...
### Course Description
Security steering committees, policies vs standards, NIST Risk Management Framework, quantitative ALE calculation, BIA recovery objectives, GDPR privacy, and SOC auditing.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **ISACA Certified Information Security Manager (CISM)** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **ISACA Certified Information Security Manager (CISM)** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [NIST Risk Management Framework (SP 800-37) & Security Controls (SP 800-53)](https://csrc.nist.gov/publications/)
    *   **Primary Video Lecture Course:** [ISACA CISM / Cyber GRC Course Playlist](https://www.youtube.com/playlist?list=PLbnu8t2G_vG0V7kC0V3n_nU9Y3S-4K178)
    *   **Official Vendor Reference Portal:** [NIST Cybersecurity Framework Reference Library](https://www.nist.gov/cyberframework)
...
*   **Module 01:** Security Governance Frameworks
*   **Module 02:** Security Policies & Standards
*   **Module 03:** Risk Management Frameworks
*   **Module 04:** Asset Identification & Valuation
*   **Module 05:** Risk Assessment Methodology
*   **Module 06:** Risk Mitigation Strategies
*   **Module 07:** Business Impact Analysis
*   **Module 08:** Disaster Recovery & Business Continuity
*   **Module 09:** Regulatory Compliance (HIPAA, SOX)
*   **Module 10:** Privacy Regulations (GDPR, CCPA)
*   **Module 11:** Industry Standards (PCI-DSS, ISO)
*   **Module 12:** Security Auditing Procedures
*   **Module 13:** Vendor Risk Management
*   **Module 14:** Security Awareness Programs
*   **Module 15:** Incident Response Governance
*   **Module 16:** Final Exam Prep & Certification Exam (ISACA Certified Information Security Manager (CISM))
