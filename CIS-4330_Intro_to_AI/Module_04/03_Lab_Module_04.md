# Lab Activity: Module 04 - Data Preprocessing
## Course: CIS-4330_Intro_to_AI (AI-900 (Microsoft Azure AI Fundamentals))

---

## Objective
Configure and verify systems matching the operational parameters of **Data Preprocessing**.
...
1. **Impute missing values using Pandas `fillna()` method**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Scale numerical features to 0-1 range using MinMaxScaler**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Convert text categories to binary columns using `get_dummies()`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
