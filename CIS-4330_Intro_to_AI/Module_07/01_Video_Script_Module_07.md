...
*   **Visual:** Instructor on camera with a title card displaying: **Evaluating Machine Learning Models**.
*   **Audio:** "Hello class! Today we are digging into a vital topic for the **AI-900 (Microsoft Azure AI Fundamentals)** exam: **Evaluating Machine Learning Models**. If you are new to this concept, don't worry. We will break it down step-by-step. Understanding how these systems communicate and operate is fundamental for passing your certification exam and configuring systems in a real-world enterprise environment."
*   **Study Link:** [Microsoft Azure AI Fundamentals Complete Course - Evaluating Machine Learning Models](https://www.youtube.com/watch?v=s0H3G50vGgU)

---

### [02:30 - 09:30] Conceptual Deep-Dive
*   **Visual:** Split screen showing slides and a diagram mapping the key configurations.
*   **[Alt-text: A diagram illustrating the operational relationships of Evaluating Machine Learning Models components, highlighting data paths and connection rules.]**
*   **Audio:** "Let's review the terms you need to master for this week's unit:
    Confusion matrix, Accuracy, Precision, Recall, F1-Score, Mean Squared Error (MSE).
...
*   **[Alt-text: Command line console output showing the verification runs for Evaluating Machine Learning Models.]**
