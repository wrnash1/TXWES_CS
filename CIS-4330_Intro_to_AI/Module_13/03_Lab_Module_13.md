# Lab Activity: Module 13 - Cloud AI Services
## Course: CIS-4330_Intro_to_AI (AI-900 (Microsoft Azure AI Fundamentals))

---

## Objective
Configure and verify systems matching the operational parameters of **Cloud AI Services**.
...
1. **Provision a Cognitive Service resource in cloud portal simulator**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Retrieve API keys and endpoint URLs**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Make a curl request to a translation API endpoint**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
