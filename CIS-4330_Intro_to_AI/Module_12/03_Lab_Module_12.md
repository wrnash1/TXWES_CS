# Lab Activity: Module 12 - Ethical AI and Responsible Deployment
## Course: CIS-4330_Intro_to_AI (AI-900 (Microsoft Azure AI Fundamentals))

---

## Objective
Configure and verify systems matching the operational parameters of **Ethical AI and Responsible Deployment**.
...
1. **Analyze a dataset for demographic bias indicators**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Review AI model parameters for privacy disclosures**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Document model lineage and limitations**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
