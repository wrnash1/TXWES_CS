...
*   **Topic Focus:** **Variables, Constants, and Scope** (specifically focusing on: `var keyword, let keyword, const keyword, block scope, hoisting, global variable.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Variables, Constants, and Scope in an enterprise system. Address the following:
