# Lab Activity: Module 12 - Event Handling & Listeners
## Course: CIS-1320_Intro_to_JavaScript (JSE (Certified Associate in JavaScript Programming))

---

## Objective
Configure and verify systems matching the operational parameters of **Event Handling & Listeners**.
...
1. **Attach a click handler to a button**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Access event details using the event parameter**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Use preventDefault on a form submit event**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
