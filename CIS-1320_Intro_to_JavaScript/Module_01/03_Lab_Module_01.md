# Lab Activity: Module 01 - JavaScript Introduction & Execution
## Course: CIS-1320_Intro_to_JavaScript (JSE (Certified Associate in JavaScript Programming))

---

## Objective
Configure and verify systems matching the operational parameters of **JavaScript Introduction & Execution**.
...
1. **Create a basic HTML page with an inline script tag**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Use console.log to print hello world**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Verify script execution in browser console**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
