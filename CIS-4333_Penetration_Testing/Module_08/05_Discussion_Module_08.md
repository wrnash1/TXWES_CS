# Discussion Forum: Module 08 - Exploiting Windows & Active Directory
...
*   **Topic Focus:** **Exploiting Windows & Active Directory** (specifically focusing on: `Kerberoasting, Pass-the-Hash, LSASS memory dumping, SMB exploitation.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Exploiting Windows & Active Directory in an enterprise system. Address the following:
