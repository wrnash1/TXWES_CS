# Lab Activity: Module 09 - Exploiting Linux Systems
## Course: CIS-4333_Penetration_Testing (CompTIA PenTest+)

---

## Objective
Configure and verify systems matching the operational parameters of **Exploiting Linux Systems**.
...
2. **Examine sudo permissions: `sudo -l`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Exploit a misconfigured SUID binary to escalate privilege**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
