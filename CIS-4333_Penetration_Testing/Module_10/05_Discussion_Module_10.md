# Discussion Forum: Module 10 - Web Application Exploit Methods
...
*   **Topic Focus:** **Web Application Exploit Methods** (specifically focusing on: `SQL Injection (SQLi), Cross-Site Scripting (XSS), Command injection, directory traversal.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Web Application Exploit Methods in an enterprise system. Address the following:
