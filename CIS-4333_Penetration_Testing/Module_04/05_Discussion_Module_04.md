# Discussion Forum: Module 04 - Active Reconnaissance (Nmap)
...
*   **Topic Focus:** **Active Reconnaissance (Nmap)** (specifically focusing on: `SYN scans (-sS) vs Connect scans (-sT), service version detection (-sV), OS detection (-O), Nmap scripting engine (-sC).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Active Reconnaissance (Nmap) in an enterprise system. Address the following:
