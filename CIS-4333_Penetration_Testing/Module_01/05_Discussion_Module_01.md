# Discussion Forum: Module 01 - Planning & Scoping Pen Tests
...
*   **Topic Focus:** **Planning & Scoping Pen Tests** (specifically focusing on: `Rules of Engagement (RoE), scoping document parameters, target classifications, permission checklists.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Planning & Scoping Pen Tests in an enterprise system. Address the following:
