...
## Objective
Configure and verify systems matching the operational parameters of **Penetration Testing Reports**.
...
1. **Draft an executive summary outlining high-level risk findings**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Format technical finding descriptions with remediation steps**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Assign CVSS ratings to findings**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
