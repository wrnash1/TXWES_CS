# Discussion Forum: Module 03 - Passive Reconnaissance (OSINT)
...
*   **Topic Focus:** **Passive Reconnaissance (OSINT)** (specifically focusing on: `Whois queries, DNS interrogation (dig, host), Shodan search filters, harvesting email addresses (theHarvester).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Passive Reconnaissance (OSINT) in an enterprise system. Address the following:
