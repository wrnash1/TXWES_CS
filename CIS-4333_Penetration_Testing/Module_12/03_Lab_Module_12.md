...
## Objective
Configure and verify systems matching the operational parameters of **Post-Exploitation & Privilege Escalation**.
...
1. **Run basic system enumeration script**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Analyze output reports for write-access vulnerabilities**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Simulate a local UAC bypass**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
