...
## Instructor LMS Setup & Grading Manual (Canvas LMS)
...
*   **If the Student Does Not Pass the Certification:** The final exam grade is prorated based on their numeric score relative to the passing threshold. Use the following formulas based on the certification vendor:
    ...
    *   **Google Cloud / Associate Databases:**
        Prorate based on the percentage of sections passed or mock-up test percentage.
    *   **Microsoft Azure (Scale 1–1000, Passing Score 700):**
        $$\text{Final Exam Grade} = \left( \frac{\text{Student Score}}{700} \right) \times 100$$
