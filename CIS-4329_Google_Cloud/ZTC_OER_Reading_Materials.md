...
1.  **Primary Open Textbook / OER Book:**
    *   [Google Cloud Associate Cloud Engineer Documentation](https://cloud.google.com/docs)
    *   *Study Guide:* Refer to this open resource for weekly reading assignments.

2.  **Video Study Stream Lectures:**
    *   [Google Cloud ACE Certification Course by freeCodeCamp](https://www.youtube.com/watch?v=UGRDM86MBIQ)
    *   *Study Guide:* Follow this playlist for weekly video lectures.

3.  **Official Vendor Documentation:**
    *   [Google Cloud Architecture Center](https://cloud.google.com/)
