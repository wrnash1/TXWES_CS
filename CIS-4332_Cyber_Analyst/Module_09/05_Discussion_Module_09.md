# Discussion Forum: Module 09 - Email & Web Security Analysis
...
*   **Topic Focus:** **Email & Web Security Analysis** (specifically focusing on: `DKIM, SPF, DMARC, SMTP logs, web proxy traffic review, HTTP status codes.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Email & Web Security Analysis in an enterprise system. Address the following:
