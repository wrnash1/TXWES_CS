# Lab Activity: Module 09 - Email & Web Security Analysis
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **Email & Web Security Analysis**.
...
1. **Analyze raw email header details for SPF validation outcomes**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Determine proxy request origin paths**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Trace malicious URL parameters**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
