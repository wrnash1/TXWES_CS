# Discussion Forum: Module 13 - Forensics & Evidence Collection
...
*   **Topic Focus:** **Forensics & Evidence Collection** (specifically focusing on: `Order of volatility, chain of custody, write blockers, disk imaging (dd).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Forensics & Evidence Collection in an enterprise system. Address the following:
