# Discussion Forum: Module 15 - Security Controls & Architecture
...
*   **Topic Focus:** **Security Controls & Architecture** (specifically focusing on: `Technical vs Administrative vs Physical controls, defense-in-depth, security logging topologies.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Security Controls & Architecture in an enterprise system. Address the following:
