# Discussion Forum: Module 07 - Host-Based Security & EDR
...
*   **Topic Focus:** **Host-Based Security & EDR** (specifically focusing on: `Endpoint Detection and Response (EDR), file integrity monitoring (FIM), local system audits.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Host-Based Security & EDR in an enterprise system. Address the following:
