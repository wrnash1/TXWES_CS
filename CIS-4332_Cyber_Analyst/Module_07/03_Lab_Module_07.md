# Lab Activity: Module 07 - Host-Based Security & EDR
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **Host-Based Security & EDR**.
...
1. **Configure a FIM utility (e.g. Tripwire) path watchlist**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Simulate a unauthorized file change in system folder**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Verify alert generated in FIM logs**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
