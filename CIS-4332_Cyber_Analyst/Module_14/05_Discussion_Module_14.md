# Discussion Forum: Module 14 - Threat Detection & Containment
...
*   **Topic Focus:** **Threat Detection & Containment** (specifically focusing on: `DNS sinkholing, firewall IP blocks, isolating VLANs, disabling compromised user accounts.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Threat Detection & Containment in an enterprise system. Address the following:
