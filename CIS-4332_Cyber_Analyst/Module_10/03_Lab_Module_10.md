# Lab Activity: Module 10 - IAM Risks and Audit
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **IAM Risks and Audit**.
...
1. **Audit user directories for accounts inactive for > 90 days**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Analyze logs for administrative privilege escalations**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Review role-based permissions mappings**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
