# Discussion Forum: Module 03 - Infrastructure Scanning Tools
...
*   **Topic Focus:** **Infrastructure Scanning Tools** (specifically focusing on: `Network vulnerability scanners, credentialed vs non-credentialed scans, Nmap vulnerability scripts.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Infrastructure Scanning Tools in an enterprise system. Address the following:
