...
*   **Topic Focus:** **Security Operations & Analyst Role** (specifically focusing on: `SOC operations, CIA Triad, threat landscape, intelligence gathering frameworks.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Security Operations & Analyst Role in an enterprise system. Address the following:
