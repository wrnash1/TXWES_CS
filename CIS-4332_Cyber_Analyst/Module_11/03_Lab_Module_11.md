# Lab Activity: Module 11 - Software Security & OWASP
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **Software Security & OWASP**.
...
1. **Identify a SQL Injection vulnerability in a code snippet**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Apply query parameterization to fix the issue**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Inspect OWASP security checklists**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
