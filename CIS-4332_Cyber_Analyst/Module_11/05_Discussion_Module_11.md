# Discussion Forum: Module 11 - Software Security & OWASP
...
*   **Topic Focus:** **Software Security & OWASP** (specifically focusing on: `OWASP Top 10 vulnerabilities (SQLi, XSS, SSRF), secure code reviews, dependency auditing.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Software Security & OWASP in an enterprise system. Address the following:
