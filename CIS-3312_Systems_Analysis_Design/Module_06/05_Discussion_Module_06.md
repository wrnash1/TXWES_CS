# Discussion Forum: Module 06 - Data Modeling (ERD)
...
*   **Topic Focus:** **Data Modeling (ERD)** (specifically focusing on: `Entity Relationship Diagrams (ERD), entities, attributes, relationships, cardinality (1:1, 1:N, M:N), Crow's Foot notation.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Data Modeling (ERD) in an enterprise system. Address the following:
