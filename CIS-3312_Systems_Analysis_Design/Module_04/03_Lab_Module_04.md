# Lab Activity: Module 04 - Use Case Analysis
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **Use Case Analysis**.
...
1. **Write a detailed use case description for 'Checkout Basket'**
