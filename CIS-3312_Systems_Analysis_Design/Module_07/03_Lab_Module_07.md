# Lab Activity: Module 07 - Object-Oriented Analysis UML
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **Object-Oriented Analysis UML**.
...
1. **Map relational ERD models to UML class structures**
