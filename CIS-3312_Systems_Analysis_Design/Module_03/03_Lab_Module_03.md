# Lab Activity: Module 03 - Requirement Gathering
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **Requirement Gathering**.
...
1. **Draft a requirements definition template**
