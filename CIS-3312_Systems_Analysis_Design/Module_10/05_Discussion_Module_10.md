# Discussion Forum: Module 10 - Database Design & Normalization
...
*   **Topic Focus:** **Database Design & Normalization** (specifically focusing on: `Normalization steps, First Normal Form (1NF), Second Normal Form (2NF), Third Normal Form (3NF), transitive dependencies.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Database Design & Normalization in an enterprise system. Address the following:
