# Lab Activity: Module 12 - Program Design
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **Program Design**.
...
1. **Draft pseudo-code specifications for core functions**
