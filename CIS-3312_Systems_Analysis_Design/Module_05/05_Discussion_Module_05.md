# Discussion Forum: Module 05 - Process Modeling (DFD)
...
*   **Topic Focus:** **Process Modeling (DFD)** (specifically focusing on: `Data Flow Diagrams (DFD), Gane & Sarson notation, processes, data flows, data stores, external entities, context diagram.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Process Modeling (DFD) in an enterprise system. Address the following:
