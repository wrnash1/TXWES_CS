# Lab Activity: Module 15 - CCNA Review and Diagnostics
## Course: CIS-3322_Advanced_Networking (Cisco CCNA (200-301))

---

## Objective
Configure and verify systems matching the operational parameters of **CCNA Review and Diagnostics**.
...
1. **Diagnose a duplex mismatch between router and switch**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Solve a routing loop issue using CLI interface counters**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Trace routing paths: `traceroute`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
