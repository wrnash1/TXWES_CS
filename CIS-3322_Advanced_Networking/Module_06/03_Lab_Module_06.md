...
## Objective
Configure and verify systems matching the operational parameters of **EtherChannel Link Aggregation**.
...
1. **Configure ports for active negotiation: `channel-group 1 mode active`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Verify port-channel interface state: `show etherchannel summary`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Configure EtherChannel load-balancing method**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
