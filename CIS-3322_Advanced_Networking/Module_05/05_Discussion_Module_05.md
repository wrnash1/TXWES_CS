...
*   **Topic Focus:** **Spanning Tree Protocol (STP & RSTP)** (specifically focusing on: `Root bridge election, port roles (Root, Designated, Blocked), 802.1D vs 802.1w (RSTP).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Spanning Tree Protocol (STP & RSTP) in an enterprise system. Address the following:
