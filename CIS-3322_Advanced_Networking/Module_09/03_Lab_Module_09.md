# Lab Activity: Module 09 - WAN Technologies & VPNs
## Course: CIS-3322_Advanced_Networking (Cisco CCNA (200-301))

---

## Objective
Configure and verify systems matching the operational parameters of **WAN Technologies & VPNs**.
...
1. **Configure a generic routing encapsulation (GRE) tunnel interface**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Set tunnel source and destination IPs**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Test routing protocols across the tunnel**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
