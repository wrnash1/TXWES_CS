# Lab Activity: Module 13 - Quality of Service (QoS) Fundamentals
## Course: CIS-3322_Advanced_Networking (Cisco CCNA (200-301))

---

## Objective
Configure and verify systems matching the operational parameters of **Quality of Service (QoS) Fundamentals**.
...
1. **Configure a class-map to match VoIP traffic**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Define a policy-map prioritizing Voip to high priority queue**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Apply policy-map to interface: `service-policy output QoS-Policy`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
