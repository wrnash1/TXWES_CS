# Discussion Forum: Module 14 - Network Automation & REST APIs
...
*   **Topic Focus:** **Network Automation & REST APIs** (specifically focusing on: `SDN controller architecture, northbound vs southbound APIs, JSON/XML data formats.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Network Automation & REST APIs in an enterprise system. Address the following:
