...
*   **Topic Focus:** **Network Architectures & Topologies** (specifically focusing on: `Three-tier architecture (Core, Distribution, Access), Collapsed Core design, spine-leaf topologies.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Network Architectures & Topologies in an enterprise system. Address the following:
