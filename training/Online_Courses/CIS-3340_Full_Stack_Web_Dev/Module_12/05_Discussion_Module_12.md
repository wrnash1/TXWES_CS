# Discussion Forum: Module 12 - React State & Props
...
*   **Topic Focus:** **React State & Props** (specifically focusing on: `Functional components, React hooks, useState, immutable props, event handling.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply React State & Props in an enterprise system. Address the following:
