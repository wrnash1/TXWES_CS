# Lab Activity: Module 11 - Frontend Frameworks (React)
## Course: CIS-3340_Full_Stack_Web_Dev (AWS Certified Developer - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Frontend Frameworks (React)**.
...
1. **Setup base react project skeleton**
