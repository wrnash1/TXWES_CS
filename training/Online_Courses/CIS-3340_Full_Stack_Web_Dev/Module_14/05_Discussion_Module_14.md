# Discussion Forum: Module 14 - Deployment to AWS
...
*   **Topic Focus:** **Deployment to AWS** (specifically focusing on: `AWS S3, EC2 hosting, security groups, public ports, PM2 service manager.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Deployment to AWS in an enterprise system. Address the following:
