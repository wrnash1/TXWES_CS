# Lab Activity: Module 09 - Relational Databases with PostgreSQL
## Course: CIS-3340_Full_Stack_Web_Dev (AWS Certified Developer - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Relational Databases with PostgreSQL**.
...
1. **Write raw SQL scripts to create tables**
