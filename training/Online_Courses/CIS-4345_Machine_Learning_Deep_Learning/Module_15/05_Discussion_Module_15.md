# Discussion Forum: Module 15 - Model Deployment & Serving
...
*   **Topic Focus:** **Model Deployment & Serving** (specifically focusing on: `Model serialization (Keras H5, TensorFlow SavedModel), REST API frameworks, hosting options.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Model Deployment & Serving in an enterprise system. Address the following:
