# Discussion Forum: Module 02 - Linear Regression
...
*   **Topic Focus:** **Linear Regression** (specifically focusing on: `Continuous output variables, cost function (MSE), gradient descent steps, weights and biases.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Linear Regression in an enterprise system. Address the following:
