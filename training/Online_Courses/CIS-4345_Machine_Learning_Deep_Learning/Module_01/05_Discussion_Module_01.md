# Discussion Forum: Module 01 - Introduction to ML Pipelines
...
*   **Topic Focus:** **Introduction to ML Pipelines** (specifically focusing on: `Machine learning lifecycle, data collection, feature extraction, train-test split, label definitions.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Introduction to ML Pipelines in an enterprise system. Address the following:
