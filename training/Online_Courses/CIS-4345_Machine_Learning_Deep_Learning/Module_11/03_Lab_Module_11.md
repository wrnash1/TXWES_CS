# Lab Activity: Module 11 - Convolutional Neural Networks
## Course: CIS-4345_Machine_Learning_Deep_Learning (TensorFlow Developer Certificate)

---

## Objective
Configure and verify systems matching the operational parameters of **Convolutional Neural Networks**.
...
1. **Define a CNN layout using TensorFlow Keras Sequential API**
