# CIS-4345_Machine_Learning_Deep_Learning: Zero Textbook Cost (ZTC) OER Guide
...
1.  **Primary Open Educational Resource (OER):** Scikit-Learn & TensorFlow Documentation (scikit-learn.org / tensorflow.org)
