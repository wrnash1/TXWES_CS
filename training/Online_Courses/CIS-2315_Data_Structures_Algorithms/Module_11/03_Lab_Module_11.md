# Lab Activity: Module 11 - Dijkstra's Shortest Path
## Course: CIS-2315_Data_Structures_Algorithms (Technical Interview Readiness (LeetCode / HackerRank))

---

## Objective
Configure and verify systems matching the operational parameters of **Dijkstra's Shortest Path**.
...
1. **Write Dijkstra algorithm on weighted adjacency list**
