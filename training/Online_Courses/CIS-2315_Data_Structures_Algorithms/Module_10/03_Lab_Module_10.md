# Lab Activity: Module 10 - Breadth-First & Depth-First Search
## Course: CIS-2315_Data_Structures_Algorithms (Technical Interview Readiness (LeetCode / HackerRank))

---

## Objective
Configure and verify systems matching the operational parameters of **Breadth-First & Depth-First Search**.
...
1. **Implement BFS algorithm on adjacency list using a queue**
