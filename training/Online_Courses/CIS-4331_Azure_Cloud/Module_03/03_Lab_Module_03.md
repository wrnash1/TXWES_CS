# Lab Activity: Module 03 - Azure Virtual Machines & Scale Sets
## Course: CIS-4331_Azure_Cloud (Microsoft Azure Fundamentals (AZ-900))

---

## Objective
Configure and verify systems matching the operational parameters of **Azure Virtual Machines & Scale Sets**.
...
1. **Provision an Azure Linux VM using portal template**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Set up auto-scaling properties on a VM Scale Set**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Verify VM SSH access**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
