# Discussion Forum: Module 08 - Microsoft Entra ID (Azure AD) Basics
...
*   **Topic Focus:** **Microsoft Entra ID (Azure AD) Basics** (specifically focusing on: `Microsoft Entra ID directory structure, tenant, users, groups, hybrid identity, Azure AD Connect.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Microsoft Entra ID (Azure AD) Basics in an enterprise system. Address the following:
