# Discussion Forum: Module 15 - Azure Resource Manager (ARM) & CLI
...
*   **Topic Focus:** **Azure Resource Manager (ARM) & CLI** (specifically focusing on: `ARM templates (declarative JSON), Azure CLI, Azure Cloud Shell, PowerShell module.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Azure Resource Manager (ARM) & CLI in an enterprise system. Address the following:
