# Discussion Forum: Module 11 - Azure Security Tools
...
*   **Topic Focus:** **Azure Security Tools** (specifically focusing on: `Microsoft Defender for Cloud, Security Center, Azure Key Vault, Azure Sentinel (SIEM).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Azure Security Tools in an enterprise system. Address the following:
