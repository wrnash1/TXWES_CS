# Lab Activity: Module 11 - Azure Security Tools
## Course: CIS-4331_Azure_Cloud (Microsoft Azure Fundamentals (AZ-900))

---

## Objective
Configure and verify systems matching the operational parameters of **Azure Security Tools**.
...
1. **Provision an Azure Key Vault resource**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Securely add a secret to the vault**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Retrieve secret using cloud CLI command**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
