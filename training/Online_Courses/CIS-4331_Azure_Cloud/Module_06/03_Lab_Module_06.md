...
## Objective
Configure and verify systems matching the operational parameters of **Azure Storage Services**.
...
2. **Upload a blob to a Container**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Modify blob access tier from Hot to Archive**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
