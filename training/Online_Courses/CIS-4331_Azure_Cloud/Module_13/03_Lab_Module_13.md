...
## Objective
Configure and verify systems matching the operational parameters of **Azure Monitoring and Diagnostics**.
...
1. **Examine Azure Advisor suggestions for cost and security**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Configure an Azure Monitor metric alert**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Verify Service Health dashboard status**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
