# Lab Activity: Module 10 - Azure RBAC and Subscriptions
## Course: CIS-4331_Azure_Cloud (Microsoft Azure Fundamentals (AZ-900))

---

## Objective
Configure and verify systems matching the operational parameters of **Azure RBAC and Subscriptions**.
...
1. **Assign 'Reader' role to a user at the Resource Group scope**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Verify user cannot delete resources**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Create a custom role template**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
