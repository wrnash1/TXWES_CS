# Lab Activity: Module 14 - Data Warehousing and ETL
## Course: CIS-4336_Data_Analytics (CompTIA Data+)

---

## Objective
Configure and verify systems matching the operational parameters of **Data Warehousing and ETL**.
...
1. **Design an ETL pipeline workflow**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Map transformation steps: format, clean, compute**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Define warehouse loading schema**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
