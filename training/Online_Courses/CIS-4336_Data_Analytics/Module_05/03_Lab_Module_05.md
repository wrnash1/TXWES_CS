# Lab Activity: Module 05 - Handling Missing Data and Outliers
## Course: CIS-4336_Data_Analytics (CompTIA Data+)

---

## Objective
Configure and verify systems matching the operational parameters of **Handling Missing Data and Outliers**.
...
1. **Calculate IQR for a dataset of house prices**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Identify outlier prices using IQR thresholds**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Impute missing ages using dataset median**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
