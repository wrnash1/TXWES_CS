# Lab Activity: Module 10 - Creating Dashboards & Reports
## Course: CIS-4336_Data_Analytics (CompTIA Data+)

---

## Objective
Configure and verify systems matching the operational parameters of **Creating Dashboards & Reports**.
...
1. **Wireframe a KPI dashboard layout**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Configure filter requirements for regional sales data**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Select key metrics for dashboard header**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
