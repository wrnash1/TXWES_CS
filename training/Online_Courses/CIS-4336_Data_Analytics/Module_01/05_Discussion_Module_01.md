# Discussion Forum: Module 01 - Fundamentals of Data Analytics
...
*   **Topic Focus:** **Fundamentals of Data Analytics** (specifically focusing on: `Data analytics lifecycle, structured vs unstructured data, qualitative vs quantitative variables.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Fundamentals of Data Analytics in an enterprise system. Address the following:
