# Discussion Forum: Module 04 - Data Cleaning & Normalization
...
*   **Topic Focus:** **Data Cleaning & Normalization** (specifically focusing on: `Deduplication, handling missing values, type casting, text cleaning (regex), normalizing schemas.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Data Cleaning & Normalization in an enterprise system. Address the following:
