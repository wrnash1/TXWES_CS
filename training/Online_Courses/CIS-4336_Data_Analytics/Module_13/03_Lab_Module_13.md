# Lab Activity: Module 13 - Data Governance & Privacy
## Course: CIS-4336_Data_Analytics (CompTIA Data+)

---

## Objective
Configure and verify systems matching the operational parameters of **Data Governance & Privacy**.
...
1. **Identify PII columns in a customer dataset (e.g. email, SSN)**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Apply data masking to hide credit card digits**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Document data access roles**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
