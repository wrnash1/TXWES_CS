# Lab Activity: Module 15 - Security Controls & Architecture
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **Security Controls & Architecture**.
...
1. **Audit physical security layouts**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Review technical control configuration details**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Draft a defense-in-depth policy model**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
