# Discussion Forum: Module 06 - IDS/IPS Tools & Monitoring
...
*   **Topic Focus:** **IDS/IPS Tools & Monitoring** (specifically focusing on: `Signature-based vs anomaly-based detection, Snort rule configuration, inline vs passive placement.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply IDS/IPS Tools & Monitoring in an enterprise system. Address the following:
