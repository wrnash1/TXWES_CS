# Lab Activity: Module 06 - IDS/IPS Tools & Monitoring
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **IDS/IPS Tools & Monitoring**.
...
1. **Review a Snort rule file structure**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Write a basic rule to alert on ICMP packets**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Examine PCAP captures for alert triggers**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
