# Lab Activity: Module 12 - Incident Response Frameworks
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **Incident Response Frameworks**.
...
1. **Draft containment strategies for a compromised web host**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Analyze indicator severity levels**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Document lessons-learned steps**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
