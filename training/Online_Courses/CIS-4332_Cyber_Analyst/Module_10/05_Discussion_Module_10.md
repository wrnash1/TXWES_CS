# Discussion Forum: Module 10 - IAM Risks and Audit
...
*   **Topic Focus:** **IAM Risks and Audit** (specifically focusing on: `Privileged account abuse, orphan accounts, access reviews, multifactor authentication gaps.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply IAM Risks and Audit in an enterprise system. Address the following:
