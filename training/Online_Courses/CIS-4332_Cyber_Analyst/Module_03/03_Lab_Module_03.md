# Lab Activity: Module 03 - Infrastructure Scanning Tools
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **Infrastructure Scanning Tools**.
...
1. **Configure a basic vulnerability scan target list**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Perform a mock Nmap NSE script scan**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Analyze scanning speed impacts on network bandwidth**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
