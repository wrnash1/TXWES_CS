# Discussion Forum: Module 05 - Threat Intelligence & Hunting
...
*   **Topic Focus:** **Threat Intelligence & Hunting** (specifically focusing on: `MITRE ATT&CK framework, Cyber Kill Chain, threat intelligence feeds (STIX/TAXII).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Threat Intelligence & Hunting in an enterprise system. Address the following:
