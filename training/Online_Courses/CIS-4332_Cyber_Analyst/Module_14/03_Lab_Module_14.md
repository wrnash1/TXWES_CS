# Lab Activity: Module 14 - Threat Detection & Containment
## Course: CIS-4332_Cyber_Analyst (CompTIA CySA+)

---

## Objective
Configure and verify systems matching the operational parameters of **Threat Detection & Containment**.
...
1. **Configure a firewall rule to block command-and-control IP**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Implement a DNS sinkhole mapping for suspicious domain**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Review account suspension scripts**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
