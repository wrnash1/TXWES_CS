# Discussion Forum: Module 10 - Terraform Modules
...
*   **Topic Focus:** **Terraform Modules** (specifically focusing on: `Module definition, root module, child modules, input parameters, module output mapping.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Terraform Modules in an enterprise system. Address the following:
