# Lab Activity: Module 04 - Terraform Variables & Outputs
## Course: CIS-4337_Infrastructure_Automation (HashiCorp Certified: Terraform Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Terraform Variables & Outputs**.
...
1. **Define input variables for resource parameters**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Set variable values in a `terraform.tfvars` file**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Declare outputs to print deployment values**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
