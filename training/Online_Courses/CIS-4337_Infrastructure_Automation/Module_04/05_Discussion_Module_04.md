# Discussion Forum: Module 04 - Terraform Variables & Outputs
...
*   **Topic Focus:** **Terraform Variables & Outputs** (specifically focusing on: `Input variables (string, list, map), default parameters, outputs, local variables.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Terraform Variables & Outputs in an enterprise system. Address the following:
