# Lab Activity: Module 14 - AWS High Availability Patterns
## Course: CIS-4334_AWS_Cloud_Architecture (AWS Certified Solutions Architect - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **AWS High Availability Patterns**.
...
1. **Draft high-availability architecture model**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Map out database replication paths**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Configure active-passive failover routes**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
