# Discussion Forum: Module 04 - AWS Network Security
...
*   **Topic Focus:** **AWS Network Security** (specifically focusing on: `Security Groups (stateful) vs Network ACLs (stateless), inbound/outbound rules.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply AWS Network Security in an enterprise system. Address the following:
