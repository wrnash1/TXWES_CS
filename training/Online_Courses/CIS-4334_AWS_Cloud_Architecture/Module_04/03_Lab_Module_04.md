# Lab Activity: Module 04 - AWS Network Security
## Course: CIS-4334_AWS_Cloud_Architecture (AWS Certified Solutions Architect - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **AWS Network Security**.
...
1. **Configure a stateful Security Group rule for port 80 traffic**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Create a stateless NACL rule blocking specific subnet range**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Verify rule matching outcomes**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
