# Discussion Forum: Module 05 - AWS IAM (Identity Access Management)
...
*   **Topic Focus:** **AWS IAM (Identity Access Management)** (specifically focusing on: `IAM users, groups, roles, JSON policy policies, multifactor authentication.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply AWS IAM (Identity Access Management) in an enterprise system. Address the following:
