# Discussion Forum: Module 08 - System Architecture & Design
...
*   **Topic Focus:** **System Architecture & Design** (specifically focusing on: `Architecture design, client-server models, cloud vs local hosting, network layouts.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply System Architecture & Design in an enterprise system. Address the following:
