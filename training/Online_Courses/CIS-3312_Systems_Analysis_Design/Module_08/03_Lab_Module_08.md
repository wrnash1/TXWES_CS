# Lab Activity: Module 08 - System Architecture & Design
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **System Architecture & Design**.
...
1. **Map client-server architecture layouts**
