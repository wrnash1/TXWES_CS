...
*   **Visual:** Instructor on camera with a title card displaying: **Database Design & Normalization**.
*   **Audio:** "Hello class! Today we are digging into a vital topic for the **IIBA Entry Certificate in Business Analysis (ECBA)** exam: **Database Design & Normalization**. If you are new to this concept, don't worry. We will break it down step-by-step. Understanding how these systems communicate and operate is fundamental for passing your certification exam and configuring systems in a real-world enterprise environment."
*   **Study Link:** [Watch Video Lecture / Study Stream on YouTube](https://www.youtube.com/results?search_query=IIBA+Entry+Certificate+in+Business+Analysis+%28ECBA%29+Database+Design+%26+Normalization)

---

### [02:30 - 09:30] Conceptual Deep-Dive
*   **Visual:** Split screen showing slides and a diagram mapping the key configurations.
*   **[Alt-text: A diagram illustrating the operational relationships of Database Design & Normalization components, highlighting data paths and connection rules.]**
*   **Audio:** "Let's review the terms you need to master for this week's unit:
    Normalization steps, First Normal Form (1NF), Second Normal Form (2NF), Third Normal Form (3NF), transitive dependencies.
...
*   **[Alt-text: Command line console output showing the verification runs for Database Design & Normalization.]**
