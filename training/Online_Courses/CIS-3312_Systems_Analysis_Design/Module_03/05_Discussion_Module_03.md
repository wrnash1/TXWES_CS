# Discussion Forum: Module 03 - Requirement Gathering
...
*   **Topic Focus:** **Requirement Gathering** (specifically focusing on: `Functional vs non-functional requirements, interview strategies, questionnaires, JAD sessions, prototyping.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Requirement Gathering in an enterprise system. Address the following:
