# Lab Activity: Module 02 - Feasibility Analysis
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **Feasibility Analysis**.
...
1. **Compute Return on Investment (ROI) and Payback Period**
