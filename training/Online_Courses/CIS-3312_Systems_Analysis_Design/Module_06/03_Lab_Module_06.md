# Lab Activity: Module 06 - Data Modeling (ERD)
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **Data Modeling (ERD)**.
...
1. **Identify entities and attributes in a customer ordering scenario**
