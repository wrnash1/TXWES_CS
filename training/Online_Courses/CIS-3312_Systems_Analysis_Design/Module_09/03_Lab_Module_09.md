# Lab Activity: Module 09 - User Interface Design
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **User Interface Design**.
...
1. **Sketch wireframe interfaces for client portal screens**
