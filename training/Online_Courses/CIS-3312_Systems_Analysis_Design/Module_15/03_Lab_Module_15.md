# Lab Activity: Module 15 - Post-Implementation & Support
## Course: CIS-3312_Systems_Analysis_Design (IIBA Entry Certificate in Business Analysis (ECBA))

---

## Objective
Configure and verify systems matching the operational parameters of **Post-Implementation & Support**.
...
1. **Classify maintenance requests into categories**
