# Discussion Forum: Module 12 - Program Design
...
*   **Topic Focus:** **Program Design** (specifically focusing on: `Structure charts, pseudo-code, modular design, coupling vs cohesion.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Program Design in an enterprise system. Address the following:
