...
## Objective
Configure and verify systems matching the operational parameters of **Scopes, Namespaces, and Recursion**.
...
2. **Demonstrate local scope variable shadow**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Modify a global variable from inside a function using `global`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
