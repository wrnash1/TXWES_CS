...
## Objective
Configure and verify systems matching the operational parameters of **Exception Handling**.
...
1. **Write a script that takes numbers from user and handles ValueError**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Use try-except-finally to ensure database or file connection is closed**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Raise a custom ValueError if negative values are input**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
