...
## Objective
Configure and verify systems matching the operational parameters of **String Methods and Operations**.
...
1. **Take a user input string and clean it up (remove whitespace)**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Split it into words based on spaces**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Join the words back together using a hyphen `-` separator**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
