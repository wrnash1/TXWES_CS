# Lab Activity: Module 10 - Tuples and Dictionaries
## Course: CIS-1310_Intro_to_Python (PCAP (Certified Associate in Python Programming))

---

## Objective
Configure and verify systems matching the operational parameters of **Tuples and Dictionaries**.
...
1. **Create a dictionary storing student names and grades**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Retrieve grades using student names**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Iterate through keys and values using `.items()`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
4. **Verify tuples cannot be modified**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
