# Lab Activity: Module 06 - Bitwise Operations and Lists
## Course: CIS-1310_Intro_to_Python (PCAP (Certified Associate in Python Programming))

---

## Objective
Configure and verify systems matching the operational parameters of **Bitwise Operations and Lists**.
...
2. **Access colors using positive and negative indices**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Modify the third color**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
4. **Perform slicing `colors[1:4]` and print results**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
