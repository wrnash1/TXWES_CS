# Discussion Forum: Module 12 - Container Security & Scan
...
*   **Topic Focus:** **Container Security & Scan** (specifically focusing on: `Container base images, image scanning (Trivy), rootless containers, registry configurations.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Container Security & Scan in an enterprise system. Address the following:
