# Lab Activity: Module 13 - Monitoring, Logging & Telemetry
## Course: CIS-4350_DevSecOps_CICD_Pipelines (Certified DevSecOps Professional (CDP))

---

## Objective
Configure and verify systems matching the operational parameters of **Monitoring, Logging & Telemetry**.
...
1. **Map application telemetry flows**
