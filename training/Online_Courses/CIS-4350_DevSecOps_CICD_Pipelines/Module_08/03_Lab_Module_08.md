# Lab Activity: Module 08 - Software Composition Analysis
## Course: CIS-4350_DevSecOps_CICD_Pipelines (Certified DevSecOps Professional (CDP))

---

## Objective
Configure and verify systems matching the operational parameters of **Software Composition Analysis**.
...
1. **Run a SCA scan on dependencies**
