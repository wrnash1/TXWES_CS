# Discussion Forum: Module 11 - Secret Management in Pipelines
...
*   **Topic Focus:** **Secret Management in Pipelines** (specifically focusing on: `Secret scanning, git leaks prevention, HashiCorp Vault, encrypted env variables.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Secret Management in Pipelines in an enterprise system. Address the following:
