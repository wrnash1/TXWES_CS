# Lab Activity: Module 06 - Static Application Security Testing
## Course: CIS-4350_DevSecOps_CICD_Pipelines (Certified DevSecOps Professional (CDP))

---

## Objective
Configure and verify systems matching the operational parameters of **Static Application Security Testing**.
...
1. **Configure a SAST scanner tool in pipeline**
