# CIS-4350_DevSecOps_CICD_Pipelines: Zero Textbook Cost (ZTC) OER Guide
...
1.  **Primary Open Educational Resource (OER):** DevSecOps Reference Architecture (devsecops.org)
