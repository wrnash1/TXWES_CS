# Lab Activity: Module 15 - DevSecOps Compliance & Audit
## Course: CIS-4350_DevSecOps_CICD_Pipelines (Certified DevSecOps Professional (CDP))

---

## Objective
Configure and verify systems matching the operational parameters of **DevSecOps Compliance & Audit**.
...
1. **Verify signed git commits indicators**
