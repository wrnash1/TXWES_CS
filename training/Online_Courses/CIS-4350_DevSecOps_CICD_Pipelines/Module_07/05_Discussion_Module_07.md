# Discussion Forum: Module 07 - Dynamic Application Security Testing
...
*   **Topic Focus:** **Dynamic Application Security Testing** (specifically focusing on: `DAST scanners, OWASP ZAP, active scanning, sandbox testing, network responses.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Dynamic Application Security Testing in an enterprise system. Address the following:
