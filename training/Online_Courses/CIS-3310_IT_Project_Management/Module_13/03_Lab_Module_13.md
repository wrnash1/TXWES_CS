# Lab Activity: Module 13 - Project Execution & Performance Reporting
## Course: CIS-3310_IT_Project_Management (CompTIA Project+ / PMI CAPM)

---

## Objective
Configure and verify systems matching the operational parameters of **Project Execution & Performance Reporting**.
...
1. **Calculate cost variance (CV) and schedule variance (SV)**
