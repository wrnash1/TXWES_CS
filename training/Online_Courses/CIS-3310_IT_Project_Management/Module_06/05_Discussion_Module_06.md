# Discussion Forum: Module 06 - Cost Estimation & Budgeting
...
*   **Topic Focus:** **Cost Estimation & Budgeting** (specifically focusing on: `Analogous vs parametric estimating, bottom-up estimation, contingency reserves, cost baseline.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Cost Estimation & Budgeting in an enterprise system. Address the following:
