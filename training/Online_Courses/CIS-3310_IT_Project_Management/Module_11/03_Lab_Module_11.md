# Lab Activity: Module 11 - IT Procurement & Contracts
## Course: CIS-3310_IT_Project_Management (CompTIA Project+ / PMI CAPM)

---

## Objective
Configure and verify systems matching the operational parameters of **IT Procurement & Contracts**.
...
1. **Review a vendor service level agreement (SLA)**
