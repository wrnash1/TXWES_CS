# Quiz: Module 02 - Project Charter Development
## Course: CIS-3310_IT_Project_Management (CompTIA Project+ / PMI CAPM)

---

**Question 1**
Which document authorizes the formal existence of a project and gives the project manager authority to apply resources?
*   A) Project Scope Statement
*   B) Project Charter
*   C) Work Breakdown Structure
*   D) Statement of Work (SOW)
*   **Correct Answer:** B) The Project Charter is signed by sponsors to initiate the project and authorize resources.
*   **Distractor Analysis:**
    *   *Why correct:* The Project Charter is signed by sponsors to initiate the project and authorize resources.
    *   Scope statement defines deliverables. WBS is a decomposition tree.

---

**Question 2**
In the context of standard IT systems, which of the following is the most accurate definition of the concept or parameter **Project charter purpose**?
...
*   **Distractor Analysis:**
    * *Why D is incorrect:* This option represents an alternative operational definition that does not apply to **Project charter purpose**.
    * *Why A is correct:* This describes the exact role and function of **Project charter purpose**.
    * *Why B is incorrect:* This option represents an alternative operational definition that does not apply to **Project charter purpose**.
    * *Why C is incorrect:* This option represents an alternative operational definition that does not apply to **Project charter purpose**.
...
**Question 4**
While working on **Project Charter Development** in a production environment, you encounter a system alert indicating a **SLA Breach Alert** error. Which of the following is the most effective troubleshooting action to resolve this issue?
...
**Question 5**
When designing a system for **Project Charter Development**, you must mitigate the risk of **Stakeholders requesting changes directly to developers, leading to untracked features and security vulnerabilities.**. Which of the following security configurations or controls represents the best practice to implement?
