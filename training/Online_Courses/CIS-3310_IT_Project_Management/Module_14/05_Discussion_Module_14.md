# Discussion Forum: Module 14 - Project Change Control
...
*   **Topic Focus:** **Project Change Control** (specifically focusing on: `Change request forms, Change Control Board (CCB), configuration management, impact assessment.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Project Change Control in an enterprise system. Address the following:
