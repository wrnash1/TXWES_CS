# Discussion Forum: Module 03 - Defining Scope & WBS
...
*   **Topic Focus:** **Defining Scope & WBS** (specifically focusing on: `Work Breakdown Structure (WBS), decomposition, work packages, scope creep, WBS dictionary.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Defining Scope & WBS in an enterprise system. Address the following:
