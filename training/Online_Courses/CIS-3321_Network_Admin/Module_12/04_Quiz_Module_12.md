# Quiz: Module 12 - High Availability
...
D) The translation of human-readable domain names into machine-readable IP addresses.
...
**Question 4**
While working on **High Availability** in a production environment, you encounter a system alert indicating a **Subnet Mask Mismatch** error. Which of the following is the most effective troubleshooting action to resolve this issue?
...
**Question 5**
When designing a system for **High Availability**, you must mitigate the risk of **Attackers connecting rogue access points or unauthorized laptops directly to internal switch ports.**. Which of the following security configurations or controls represents the best practice to implement?
