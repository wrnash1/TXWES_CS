# Lab Activity: Module 08 - Exploiting Windows & Active Directory
## Course: CIS-4333_Penetration_Testing (CompTIA PenTest+)

---

## Objective
Configure and verify systems matching the operational parameters of **Exploiting Windows & Active Directory**.
...
1. **Simulate SMB credential verification**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Dump local credentials memory structure**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Analyze Windows privilege tokens**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
