# Discussion Forum: Module 06 - Social Engineering Attacks
...
*   **Topic Focus:** **Social Engineering Attacks** (specifically focusing on: `Phishing email layout, vishing, tailgating, baiting, spear-phishing vs whaling.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Social Engineering Attacks in an enterprise system. Address the following:
