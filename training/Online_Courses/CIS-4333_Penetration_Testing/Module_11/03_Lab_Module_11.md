...
## Objective
Configure and verify systems matching the operational parameters of **Wireless Network Assessment**.
...
1. **Put wireless interface in monitor mode: `airmon-ng start wlan0`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Capture WPA2 4-way handshake using airodump-ng**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Review handshake wordlist cracking syntax**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
