# Lab Activity: Module 02 - Legal & Ethical Considerations
## Course: CIS-4333_Penetration_Testing (CompTIA PenTest+)

---

## Objective
Configure and verify systems matching the operational parameters of **Legal & Ethical Considerations**.
...
1. **Review a customer pen test authorization letter**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Determine regulatory compliance requirements**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Examine liability exemptions**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
