# Discussion Forum: Module 07 - Exploiting Network Vulnerabilities
...
*   **Topic Focus:** **Exploiting Network Vulnerabilities** (specifically focusing on: `Metasploit framework console (msfconsole), search exploits, payloads, reverse vs bind shells.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Exploiting Network Vulnerabilities in an enterprise system. Address the following:
