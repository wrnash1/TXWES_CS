# Lab Activity: Module 04 - Control Flow & Conditionals
## Course: CIS-1320_Intro_to_JavaScript (JSE (Certified Associate in JavaScript Programming))

---

## Objective
Configure and verify systems matching the operational parameters of **Control Flow & Conditionals**.
...
1. **Write a conditional block evaluating test grades**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Implement a switch statement mapping weekdays**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Rewrite an if/else block using a ternary operator**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
