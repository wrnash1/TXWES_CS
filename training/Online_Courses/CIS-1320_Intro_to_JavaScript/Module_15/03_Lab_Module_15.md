...
## Objective
Configure and verify systems matching the operational parameters of **Error Handling & Debugging**.
...
1. **Implement a try/catch block to handle division by zero**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Throw a custom error if user input is invalid**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Add debugger statements to trace variables**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
