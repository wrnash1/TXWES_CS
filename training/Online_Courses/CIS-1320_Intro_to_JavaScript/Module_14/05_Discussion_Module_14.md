# Discussion Forum: Module 14 - Promises & Async/Await
...
*   **Topic Focus:** **Promises & Async/Await** (specifically focusing on: `Promise state, resolve/reject, then/catch, async keyword, await expression, fetch API.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Promises & Async/Await in an enterprise system. Address the following:
