...
## Objective
Configure and verify systems matching the operational parameters of **Variables, Constants, and Scope**.
...
2. **Demonstrate block scope behavior of let vs var**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Trigger a TypeError by reassigning a const variable**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
