# Discussion Forum: Module 12 - Security Auditing Procedures
...
*   **Topic Focus:** **Security Auditing Procedures** (specifically focusing on: `IT audit, internal audit vs external audit, audit evidence, audit trail logs, control testing.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Security Auditing Procedures in an enterprise system. Address the following:
