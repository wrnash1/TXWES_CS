# Lab Activity: Module 02 - Security Policies & Standards
## Course: CIS-4315_Cyber_Governance_Risk_Compliance (ISACA Certified Information Security Manager (CISM))

---

## Objective
Configure and verify systems matching the operational parameters of **Security Policies & Standards**.
...
1. **Draft an acceptable use policy (AUP) template**
