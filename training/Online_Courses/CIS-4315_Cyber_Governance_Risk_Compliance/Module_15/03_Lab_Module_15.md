# Lab Activity: Module 15 - Incident Response Governance
## Course: CIS-4315_Cyber_Governance_Risk_Compliance (ISACA Certified Information Security Manager (CISM))

---

## Objective
Configure and verify systems matching the operational parameters of **Incident Response Governance**.
...
1. **Draft an incident escalation flow chart**
