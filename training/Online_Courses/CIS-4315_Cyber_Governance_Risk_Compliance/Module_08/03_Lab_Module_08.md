# Lab Activity: Module 08 - Disaster Recovery & Business Continuity
## Course: CIS-4315_Cyber_Governance_Risk_Compliance (ISACA Certified Information Security Manager (CISM))

---

## Objective
Configure and verify systems matching the operational parameters of **Disaster Recovery & Business Continuity**.
...
1. **Draft table-top exercise test agendas**
