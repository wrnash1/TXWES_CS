# Discussion Forum: Module 08 - Disaster Recovery & Business Continuity
...
*   **Topic Focus:** **Disaster Recovery & Business Continuity** (specifically focusing on: `Business Continuity Plan (BCP), Disaster Recovery Plan (DRP), hot/warm/cold sites, testing DRP (tabletop, walkthrough).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Disaster Recovery & Business Continuity in an enterprise system. Address the following:
