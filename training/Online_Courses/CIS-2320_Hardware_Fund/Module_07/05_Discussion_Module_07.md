# Discussion Forum: Module 07 - Display Technologies and Connectors
...
*   **Topic Focus:** **Display Technologies and Connectors** (specifically focusing on: `OLED vs LCD (IPS, TN, VA), HDMI vs DisplayPort vs DVI, resolution and refresh rates.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Display Technologies and Connectors in an enterprise system. Address the following:
