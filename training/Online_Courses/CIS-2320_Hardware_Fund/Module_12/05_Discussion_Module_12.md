# Discussion Forum: Module 12 - Network Infrastructure Devices
...
*   **Topic Focus:** **Network Infrastructure Devices** (specifically focusing on: `Switches vs Routers, WAPs, firewalls, modems, patch panels, PoE (Power over Ethernet).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Network Infrastructure Devices in an enterprise system. Address the following:
