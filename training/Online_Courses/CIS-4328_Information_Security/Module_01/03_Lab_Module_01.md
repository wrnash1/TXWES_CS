# Lab Activity: Module 01 - Threats
...
3. An automated script that restores the database from a snapshot if corruption is detected.
4. Security cameras in the lobby.
5. Multi-Factor Authentication (MFA) on employee email.
**Deliverable:** Submit a table with your classifications and a 1-sentence justification for each to Blackboard.
