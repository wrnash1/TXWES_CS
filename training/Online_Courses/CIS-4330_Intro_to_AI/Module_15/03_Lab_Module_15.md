# Lab Activity: Module 15 - AI System Deployment
## Course: CIS-4330_Intro_to_AI (AI-900 (Microsoft Azure AI Fundamentals))

---

## Objective
Configure and verify systems matching the operational parameters of **AI System Deployment**.
...
1. **Serialize a scikit-learn model: `import pickle; pickle.dump(...)`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Create a mock Dockerfile for hosting the model**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Send input data payload to verify API output response**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
