# Lab Activity: Module 10 - Natural Language Processing (NLP)
## Course: CIS-4330_Intro_to_AI (AI-900 (Microsoft Azure AI Fundamentals))

---

## Objective
Configure and verify systems matching the operational parameters of **Natural Language Processing (NLP)**.
...
1. **Tokenize a sample paragraph into individual words**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Filter out common stop words (e.g. 'the', 'is')**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Perform sentiment scoring on text segments**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
