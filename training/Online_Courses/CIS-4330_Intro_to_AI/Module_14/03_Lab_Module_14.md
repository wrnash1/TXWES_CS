# Lab Activity: Module 14 - Automated Machine Learning (AutoML)
## Course: CIS-4330_Intro_to_AI (AI-900 (Microsoft Azure AI Fundamentals))

---

## Objective
Configure and verify systems matching the operational parameters of **Automated Machine Learning (AutoML)**.
...
1. **Configure a mock AutoML run selecting classification as target**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Inspect performance rankings of multiple trained models**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
