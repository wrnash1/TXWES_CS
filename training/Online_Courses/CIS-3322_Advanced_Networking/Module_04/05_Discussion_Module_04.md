...
*   **Topic Focus:** **Switching Concepts & VLANs** (specifically focusing on: `VLAN membership, trunking protocols (802.1Q), Native VLAN, DTP (Dynamic Trunking Protocol).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Switching Concepts & VLANs in an enterprise system. Address the following:
