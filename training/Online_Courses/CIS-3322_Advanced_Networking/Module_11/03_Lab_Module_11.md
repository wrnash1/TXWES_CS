# Lab Activity: Module 11 - NAT and PAT Configurations
## Course: CIS-3322_Advanced_Networking (Cisco CCNA (200-301))

---

## Objective
Configure and verify systems matching the operational parameters of **NAT and PAT Configurations**.
...
1. **Configure NAT pool: `ip nat pool ...`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Map inside list to interface with overload: `ip nat inside source list 1 interface g0/0 overload`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Verify mappings: `show ip nat translations`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
