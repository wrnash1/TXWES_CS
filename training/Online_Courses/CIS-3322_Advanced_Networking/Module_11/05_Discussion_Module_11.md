# Discussion Forum: Module 11 - NAT and PAT Configurations
...
*   **Topic Focus:** **NAT and PAT Configurations** (specifically focusing on: `Static vs Dynamic NAT, Port Address Translation (PAT) / Overload, inside local/global definitions.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply NAT and PAT Configurations in an enterprise system. Address the following:
