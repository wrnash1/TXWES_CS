# Lab Activity: Module 15 - DevOps Principles
## Course: CIS-3350_Software_Engineering_Agile (Professional Scrum Master (PSM I))

---

## Objective
Configure and verify systems matching the operational parameters of **DevOps Principles**.
...
1. **Analyze infrastructure requirements for web apps**
