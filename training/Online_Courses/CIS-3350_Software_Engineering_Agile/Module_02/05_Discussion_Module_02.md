# Discussion Forum: Module 02 - Git Workflows & Branching
...
*   **Topic Focus:** **Git Workflows & Branching** (specifically focusing on: `Git branch, merge conflicts, pull requests, Gitflow workflow, rebase vs merge.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Git Workflows & Branching in an enterprise system. Address the following:
