# Quiz: Module 02 - Git Workflows & Branching
## Course: CIS-3350_Software_Engineering_Agile (Professional Scrum Master (PSM I))

---

**Question 1**
In Gitflow workflow, which branch contains production-ready code that is deployed to live systems?
*   A) develop
*   B) feature
*   C) main (master)
*   D) hotfix
*   **Correct Answer:** C) The main/master branch holds the stable, tested, production-released codebase.
*   **Distractor Analysis:**
    *   *Why correct:* The main/master branch holds the stable, tested, production-released codebase.
    *   develop branch aggregates feature branches under active development.

---

**Question 2**
In the context of standard IT systems, which of the following is the most accurate definition of the concept or parameter **Git branch**?
...
*   **Distractor Analysis:**
    * *Why B is incorrect:* This option represents an alternative operational definition that does not apply to **Git branch**.
    * *Why D is incorrect:* This option represents an alternative operational definition that does not apply to **Git branch**.
    * *Why A is correct:* This describes the exact role and function of **Git branch**.
    * *Why C is incorrect:* This option represents an alternative operational definition that does not apply to **Git branch**.
...
**Question 4**
While working on **Git Workflows & Branching** in a production environment, you encounter a system alert indicating a **KeyError** error. Which of the following is the most effective troubleshooting action to resolve this issue?
...
**Question 5**
When designing a system for **Git Workflows & Branching**, you must mitigate the risk of **Storing user credentials in plain text, making them vulnerable to database breaches.**. Which of the following security configurations or controls represents the best practice to implement?
