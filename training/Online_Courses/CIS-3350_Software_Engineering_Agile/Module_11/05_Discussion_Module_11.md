# Discussion Forum: Module 11 - Scrum Framework Roles
...
*   **Topic Focus:** **Scrum Framework Roles** (specifically focusing on: `Scrum Guide, Scrum Team, Product Owner, Scrum Master, Developers, self-managing teams.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Scrum Framework Roles in an enterprise system. Address the following:
