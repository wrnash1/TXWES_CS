# Discussion Forum: Module 06 - Design Patterns (Creational)
...
*   **Topic Focus:** **Design Patterns (Creational)** (specifically focusing on: `Design pattern classifications, Singleton pattern, Factory Method pattern, object instantiation.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Design Patterns (Creational) in an enterprise system. Address the following:
