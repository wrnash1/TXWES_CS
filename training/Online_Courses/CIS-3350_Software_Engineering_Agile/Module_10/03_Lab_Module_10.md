# Lab Activity: Module 10 - CI/CD Foundations
## Course: CIS-3350_Software_Engineering_Agile (Professional Scrum Master (PSM I))

---

## Objective
Configure and verify systems matching the operational parameters of **CI/CD Foundations**.
...
1. **Create local script running lint checks**
