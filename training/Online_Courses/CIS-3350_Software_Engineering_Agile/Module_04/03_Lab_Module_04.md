# Lab Activity: Module 04 - Object-Oriented Design (SOLID)
## Course: CIS-3350_Software_Engineering_Agile (Professional Scrum Master (PSM I))

---

## Objective
Configure and verify systems matching the operational parameters of **Object-Oriented Design (SOLID)**.
...
1. **Analyze class layouts violating SOLID rules**
