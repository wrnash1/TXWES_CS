# Discussion Forum: Module 04 - Object-Oriented Design (SOLID)
...
*   **Topic Focus:** **Object-Oriented Design (SOLID)** (specifically focusing on: `SOLID principles, Single Responsibility, Open/Closed, Liskov Substitution, Interface Segregation, Dependency Inversion.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Object-Oriented Design (SOLID) in an enterprise system. Address the following:
