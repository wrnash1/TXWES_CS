# Discussion Forum: Module 01 - IoT Architecture Layers
...
*   **Topic Focus:** **IoT Architecture Layers** (specifically focusing on: `IoT layers (Perception, Network, Support, Application), edge devices, smart sensors, gateways.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply IoT Architecture Layers in an enterprise system. Address the following:
