# Discussion Forum: Module 09 - Cryptography in Constrained Devices
...
*   **Topic Focus:** **Cryptography in Constrained Devices** (specifically focusing on: `Symmetric vs asymmetric keys, hardware encryption modules (TPM), resource constraints, hashing.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Cryptography in Constrained Devices in an enterprise system. Address the following:
