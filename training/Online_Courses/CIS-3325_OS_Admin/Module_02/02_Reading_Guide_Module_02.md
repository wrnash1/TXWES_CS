# Reading Guide: Module 02 - Command Line
## Course: CIS-3325_OS_Admin (3325_OS_Admin - CompTIA Linux+ (XK0-005))

---

### Introduction
Welcome to **Module 02 - Command Line**! This week's study material focuses on the core foundations and configuration mechanics of **Command Line** as aligned with the **3325_OS_Admin - CompTIA Linux+ (XK0-005)** certification framework. Understanding these topics is essential not only for passing the certification exam but also for administering enterprise systems in real-world environments.
...
- [ ] Watch the curated YouTube study streams matching **Command Line**.
