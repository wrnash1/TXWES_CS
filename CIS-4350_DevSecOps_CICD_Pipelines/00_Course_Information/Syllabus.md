...
### Course Syllabus: CIS-4350_DevSecOps_CICD_Pipelines - Certified DevSecOps Professional (CDP)
...
### Course Description
DevSecOps shift-left automation, commit linters, GitHub Actions YAML workflows, Docker setups, SAST/DAST testing, SCA dependencies, Vault secret masking, and chaos injections.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **Certified DevSecOps Professional (CDP)** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **Certified DevSecOps Professional (CDP)** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [DevSecOps Reference Architecture & GitHub Actions Guides](https://www.devsecops.org/)
    *   **Primary Video Lecture Course:** [CI/CD Pipeline & DevSecOps Course by freeCodeCamp](https://www.youtube.com/watch?v=scEDHsr3APg)
    *   **Official Vendor Reference Portal:** [DevSecOps Reference Guides Portal](https://www.devsecops.org/)
...
*   **Module 01:** DevSecOps Culture
*   **Module 02:** Continuous Integration Concepts
*   **Module 03:** GitHub Actions Workflow
*   **Module 04:** Package & Artifact Management
*   **Module 05:** Docker Containerization in CI/CD
*   **Module 06:** Static Application Security Testing
*   **Module 07:** Dynamic Application Security Testing
*   **Module 08:** Software Composition Analysis
*   **Module 09:** Infrastructure as Code CI/CD Integration
*   **Module 10:** Automated Cloud Deployment
*   **Module 11:** Secret Management in Pipelines
*   **Module 12:** Container Security & Scan
*   **Module 13:** Monitoring, Logging & Telemetry
*   **Module 14:** Chaos Engineering Basics
*   **Module 15:** DevSecOps Compliance & Audit
*   **Module 16:** Final Exam Prep & Certification Exam (Certified DevSecOps Professional (CDP))
