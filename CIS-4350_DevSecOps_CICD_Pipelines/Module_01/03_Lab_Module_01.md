# Lab Activity: Module 01 - DevSecOps Culture
## Course: CIS-4350_DevSecOps_CICD_Pipelines (Certified DevSecOps Professional (CDP))

---

## Objective
Configure and verify systems matching the operational parameters of **DevSecOps Culture**.
...
1. **Map security gate checks in development lifecycle**
