...
*   **Visual:** Instructor on camera with a title card displaying: **Secret Management in Pipelines**.
*   **Audio:** "Hello class! Today we are digging into a vital topic for the **Certified DevSecOps Professional (CDP)** exam: **Secret Management in Pipelines**. If you are new to this concept, don't worry. We will break it down step-by-step. Understanding how these systems communicate and operate is fundamental for passing your certification exam and configuring systems in a real-world enterprise environment."
*   **Study Link:** [CI/CD Pipeline & DevSecOps Course by freeCodeCamp - Secret Management in Pipelines](https://www.youtube.com/watch?v=scEDHsr3APg)

---

### [02:30 - 09:30] Conceptual Deep-Dive
*   **Visual:** Split screen showing slides and a diagram mapping the key configurations.
*   **[Alt-text: A diagram illustrating the operational relationships of Secret Management in Pipelines components, highlighting data paths and connection rules.]**
*   **Audio:** "Let's review the terms you need to master for this week's unit:
    Secret scanning, git leaks prevention, HashiCorp Vault, encrypted env variables.
...
*   **[Alt-text: Command line console output showing the verification runs for Secret Management in Pipelines.]**
