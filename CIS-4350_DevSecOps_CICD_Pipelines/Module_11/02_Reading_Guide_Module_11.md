# Reading Guide: Module 11 - Secret Management in Pipelines
...
*   **Study Resource:** To reinforce these concepts visually, review this targeted search query: [CI/CD Pipeline & DevSecOps Course by freeCodeCamp - Secret Management in Pipelines](https://www.youtube.com/watch?v=scEDHsr3APg).

---

### Required Readings & Videos
To prepare for this module's topics, you must complete the following readings and videos:
*   **Required Reading:** Read the section/chapter covering **Secret Management in Pipelines** in the OER Textbook: [DevSecOps Reference Architecture & GitHub Actions Guides](https://www.devsecops.org/).
*   **Required Video:** Watch the video lecture on **Secret Management in Pipelines** in the official course playlist: [CI/CD Pipeline & DevSecOps Course by freeCodeCamp](https://www.youtube.com/watch?v=scEDHsr3APg).
...
- [ ] Read the section/chapter covering **Secret Management in Pipelines** in [DevSecOps Reference Architecture & GitHub Actions Guides](https://www.devsecops.org/).
- [ ] Watch the video lecture on **Secret Management in Pipelines** in [CI/CD Pipeline & DevSecOps Course by freeCodeCamp](https://www.youtube.com/watch?v=scEDHsr3APg).
