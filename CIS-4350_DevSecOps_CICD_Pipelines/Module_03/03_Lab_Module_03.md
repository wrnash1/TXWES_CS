# Lab Activity: Module 03 - GitHub Actions Workflow
## Course: CIS-4350_DevSecOps_CICD_Pipelines (Certified DevSecOps Professional (CDP))

---

## Objective
Configure and verify systems matching the operational parameters of **GitHub Actions Workflow**.
...
1. **Write a GitHub Actions workflow script using YAML**
