# Reading Guide: Module 03 - Migration
## Course: CIS-4327_Database_Admin (4327_Database_Admin - Google Cloud Associate Database Engineer)

---

### Introduction
Welcome to **Module 03 - Migration**! This week's study material focuses on the core foundations and configuration mechanics of **Migration** as aligned with the **4327_Database_Admin - Google Cloud Associate Database Engineer** certification framework. Understanding these topics is essential not only for passing the certification exam but also for administering enterprise systems in real-world environments.
...
*   **Study Resource**: To reinforce these concepts visually, review this targeted search query: [SQL & Database Administration Course by freeCodeCamp - Migration](https://www.youtube.com/watch?v=HXV3zeQKqGY).
...
*   **Required Reading:** Read the section/chapter covering **Migration** in the OER Textbook: [Database Design by Adrienne Watt](https://opentextbc.ca/dbdesign01/).
*   **Required Video:** Watch the video lecture on **Migration** in the official course playlist: [SQL & Database Administration Course by freeCodeCamp](https://www.youtube.com/watch?v=HXV3zeQKqGY).
...
- [ ] Read the section/chapter covering **Migration** in [Database Design by Adrienne Watt](https://opentextbc.ca/dbdesign01/).
- [ ] Watch the video lecture on **Migration** in [SQL & Database Administration Course by freeCodeCamp](https://www.youtube.com/watch?v=HXV3zeQKqGY).
