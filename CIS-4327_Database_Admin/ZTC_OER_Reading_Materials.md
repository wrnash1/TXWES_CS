...
1.  **Primary Open Textbook / OER Book:**
    *   [Database Design by Adrienne Watt](https://opentextbc.ca/dbdesign01/)
    *   *Study Guide:* Refer to this open resource for weekly reading assignments.

2.  **Video Study Stream Lectures:**
    *   [SQL & Database Administration Course by freeCodeCamp](https://www.youtube.com/watch?v=HXV3zeQKqGY)
    *   *Study Guide:* Follow this playlist for weekly video lectures.

3.  **Official Vendor Documentation:**
    *   [GCP Database Engineering Architecture Center](https://cloud.google.com/architecture)
