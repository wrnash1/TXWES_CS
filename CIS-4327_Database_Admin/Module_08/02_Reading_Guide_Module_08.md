...
*   **Study Resource**: To reinforce these concepts visually, review this targeted search query: [SQL & Database Administration Course by freeCodeCamp - RTO/RPO](https://www.youtube.com/watch?v=HXV3zeQKqGY).
...
*   **Required Reading:** Read the section/chapter covering **RTO/RPO** in the OER Textbook: [Database Design by Adrienne Watt](https://opentextbc.ca/dbdesign01/).
*   **Required Video:** Watch the video lecture on **RTO/RPO** in the official course playlist: [SQL & Database Administration Course by freeCodeCamp](https://www.youtube.com/watch?v=HXV3zeQKqGY).
...
- [ ] Read the section/chapter covering **RTO/RPO** in [Database Design by Adrienne Watt](https://opentextbc.ca/dbdesign01/).
- [ ] Watch the video lecture on **RTO/RPO** in [SQL & Database Administration Course by freeCodeCamp](https://www.youtube.com/watch?v=HXV3zeQKqGY).
