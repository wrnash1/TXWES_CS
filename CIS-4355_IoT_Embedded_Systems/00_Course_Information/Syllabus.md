...
### Course Syllabus: CIS-4355_IoT_Embedded_Systems - IoT & Embedded Security (General Principles)
...
### Course Description
IoT sensing layer interfaces, bitwise GPIO operations, memory constraints, RTOS scheduling, MQTT pub-sub, secure boot verification, OTA signing, and edge processing.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **IoT & Embedded Security (General Principles)** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **IoT & Embedded Security (General Principles)** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [OWASP IoT Security Project Guides & Embedded Systems Wiki](https://owasp.org/www-project-internet-of-things/)
    *   **Primary Video Lecture Course:** [IoT Course & Embedded Systems Tutorials by freeCodeCamp](https://www.youtube.com/watch?v=h0J8f60LdB0)
    *   **Official Vendor Reference Portal:** [OWASP Internet of Things Reference Library](https://owasp.org/www-project-internet-of-things/)
...
*   **Module 01:** IoT Architecture Layers
*   **Module 02:** Microcontrollers & Interfaces
*   **Module 03:** Embedded Programming C/C++
*   **Module 04:** RTOS Concepts
*   **Module 05:** IoT Protocols (MQTT/CoAP)
*   **Module 06:** Wireless Technologies
*   **Module 07:** Cloud IoT Gateways
*   **Module 08:** Embedded Security Threats
*   **Module 09:** Cryptography in Constrained Devices
*   **Module 10:** Secure Boot & OTA updates
*   **Module 11:** IoT Gateway Security
*   **Module 12:** Data Privacy in IoT Networks
*   **Module 13:** Edge Computing Concepts
*   **Module 14:** Analyzing Telemetry Data
*   **Module 15:** Secure IoT Network Architecture
*   **Module 16:** Final Exam Prep & Certification Exam (IoT & Embedded Security (General Principles))
