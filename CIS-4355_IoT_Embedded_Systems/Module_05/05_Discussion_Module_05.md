# Discussion Forum: Module 05 - IoT Protocols (MQTT/CoAP)
...
*   **Topic Focus:** **IoT Protocols (MQTT/CoAP)** (specifically focusing on: `Message Queuing Telemetry Transport (MQTT), publisher-subscriber, MQTT broker, CoAP (UDP-based).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply IoT Protocols (MQTT/CoAP) in an enterprise system. Address the following:
