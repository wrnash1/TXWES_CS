...
## Course: CIS-4355_IoT_Embedded_Systems
...
1.  **Primary Open Textbook / OER Book:**
    *   [OWASP IoT Security Project Guides & Embedded Systems Wiki](https://owasp.org/www-project-internet-of-things/)
    *   *Study Guide:* Refer to this open resource for weekly reading assignments.

2.  **Video Study Stream Lectures:**
    *   [IoT Course & Embedded Systems Tutorials by freeCodeCamp](https://www.youtube.com/watch?v=h0J8f60LdB0)
    *   *Study Guide:* Follow this playlist for weekly video lectures.

3.  **Official Vendor Documentation:**
    *   [OWASP Internet of Things Reference Library](https://owasp.org/www-project-internet-of-things/)
    *   *Study Guide:* Refer to this official documentation for standard-body guidelines and specifications.
---
