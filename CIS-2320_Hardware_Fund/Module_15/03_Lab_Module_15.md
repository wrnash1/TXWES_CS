...
## Objective
Configure and verify systems matching the operational parameters of **Printers and Imaging**.
...
1. **Replace toner cartridge in a laser printer**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Clean ink nozzles using software maintenance utility**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Configure network print queue sharing**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
