# Discussion Forum: Module 11 - Network Hardware & Connectors
...
*   **Topic Focus:** **Network Hardware & Connectors** (specifically focusing on: `Cat5e vs Cat6 vs Cat6a, RJ-45 vs RJ-11, fiber optic connections (ST, SC, LC), T568A vs T568B pinouts.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Network Hardware & Connectors in an enterprise system. Address the following:
