...
## Objective
Configure and verify systems matching the operational parameters of **Mobile Device Connectivity**.
...
1. **Configure a mobile device email account using IMAP and SSL**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Pair a Bluetooth headset with a smartphone**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Set up a mobile hotspot**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
