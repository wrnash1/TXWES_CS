...
## Objective
Configure and verify systems matching the operational parameters of **Peripheral Devices and Interfaces**.
...
1. **Configure a USB 3.0 external drive for fast transfer rates**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Set up a KVM switch to share one monitor/keyboard between two machines**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Install drivers for biometric login scanner**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
