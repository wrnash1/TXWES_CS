# Lab Activity: Module 02 - Database Structures & Schemas
## Course: CIS-4336_Data_Analytics (CompTIA Data+)

---

## Objective
Configure and verify systems matching the operational parameters of **Database Structures & Schemas**.
...
1. **Identify primary keys in a table layout**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Link tables using foreign key relationships**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Draw a basic star schema diagram**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
