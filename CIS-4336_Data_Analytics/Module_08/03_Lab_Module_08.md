# Lab Activity: Module 08 - Descriptive vs Inferential Statistics
## Course: CIS-4336_Data_Analytics (CompTIA Data+)

---

## Objective
Configure and verify systems matching the operational parameters of **Descriptive vs Inferential Statistics**.
...
1. **Differentiate population vs sample data parameters**
...
2. **Generate summary charts**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Analyze p-value significance in a mock A/B test report**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
