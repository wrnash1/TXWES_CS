# Lab Activity: Module 04 - Data Cleaning & Normalization
## Course: CIS-4336_Data_Analytics (CompTIA Data+)

---

## Objective
Configure and verify systems matching the operational parameters of **Data Cleaning & Normalization**.
...
1. **Deduplicate a list of transaction records**
...
2. **Convert text columns to uppercase**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Handle empty entries using baseline values**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
