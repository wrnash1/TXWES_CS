# Lab Activity: Module 09 - HCL Functions & Expressions
## Course: CIS-4337_Infrastructure_Automation (HashiCorp Certified: Terraform Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **HCL Functions & Expressions**.
...
1. **Test HCL expressions using `terraform console`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Use `file()` function to load user-data scripts**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Write a conditional statement choosing CPU size based on environment**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
