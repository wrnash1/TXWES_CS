# Discussion Forum: Module 02 - Terraform Architecture
...
*   **Topic Focus:** **Terraform Architecture** (specifically focusing on: `Terraform Core, plugins, providers, HCL (HashiCorp Configuration Language), terraform init.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Terraform Architecture in an enterprise system. Address the following:
