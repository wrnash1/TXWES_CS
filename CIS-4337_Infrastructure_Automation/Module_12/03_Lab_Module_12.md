# Lab Activity: Module 12 - Drift Management & Importing
## Course: CIS-4337_Infrastructure_Automation (HashiCorp Certified: Terraform Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Drift Management & Importing**.
...
1. **Manually modify a file size in console**
...
2. **Run `terraform plan` to detect the drift**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Import a mock external resource into HCL code configuration**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
