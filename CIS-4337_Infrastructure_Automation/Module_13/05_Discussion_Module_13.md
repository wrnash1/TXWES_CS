# Discussion Forum: Module 13 - Terraform Cloud & Registry
...
*   **Topic Focus:** **Terraform Cloud & Registry** (specifically focusing on: `Terraform Cloud workspaces, VCS connection, private registry, run triggers.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Terraform Cloud & Registry in an enterprise system. Address the following:
