...
### Course Syllabus: CIS-4337_Infrastructure_Automation - HashiCorp Certified: Terraform Associate
...
### Course Description
Infrastructure as Code (IaC) concepts, Terraform settings, providers, state management, modules, workspaces, and CI/CD pipelines.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **HashiCorp Certified: Terraform Associate** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **HashiCorp Certified: Terraform Associate** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [HashiCorp Terraform Documentation & Tutorials](https://developer.hashicorp.com/terraform)
    *   **Primary Video Lecture Course:** [HashiCorp Terraform Associate Complete Course](https://www.youtube.com/watch?v=V53S9wB5SgA)
    *   **Official Vendor Reference Portal:** [HashiCorp Developer Reference Portal](https://developer.hashicorp.com/terraform)
...
*   **Module 01:** IaC Concepts & Benefits
*   **Module 02:** Terraform Architecture
*   **Module 03:** Settings, Providers, & Resources
*   **Module 04:** Terraform Variables & Outputs
*   **Module 05:** Terraform State Management
*   **Module 06:** State Locking & Backends
*   **Module 07:** Provisioners & Local Exec
*   **Module 08:** Data Sources & Dynamic Blocks
*   **Module 09:** HCL Functions & Expressions
*   **Module 10:** Terraform Modules
*   **Module 11:** Workspaces & Multi-Env
*   **Module 12:** Drift Management & Importing
*   **Module 13:** Terraform Cloud & Registry
*   **Module 14:** Terraform in CI/CD Pipelines
*   **Module 15:** Terraform Security & Secrets
*   **Module 16:** Final Exam Prep & Certification Exam (HashiCorp Certified: Terraform Associate)
