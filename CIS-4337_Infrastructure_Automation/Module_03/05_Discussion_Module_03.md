# Discussion Forum: Module 03 - Settings, Providers, & Resources
...
*   **Topic Focus:** **Settings, Providers, & Resources** (specifically focusing on: `Terraform blocks, provider block parameters, resource block parameters, dependency resolution.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Settings, Providers, & Resources in an enterprise system. Address the following:
