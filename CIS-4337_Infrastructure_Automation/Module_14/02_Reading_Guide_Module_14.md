...
*   **Study Resource:** To reinforce these concepts visually, review this targeted search query: [HashiCorp Terraform Associate Complete Course - Terraform in CI/CD Pipelines](https://www.youtube.com/watch?v=V53S9wB5SgA).

---

### Required Readings & Videos
To prepare for this module's topics, you must complete the following readings and videos:
*   **Required Reading:** Read the section/chapter covering **Terraform in CI/CD Pipelines** in the OER Textbook: [HashiCorp Terraform Documentation & Tutorials](https://developer.hashicorp.com/terraform).
*   **Required Video:** Watch the video lecture on **Terraform in CI/CD Pipelines** in the official course playlist: [HashiCorp Terraform Associate Complete Course](https://www.youtube.com/watch?v=V53S9wB5SgA).
...
- [ ] Read the section/chapter covering **Terraform in CI/CD Pipelines** in [HashiCorp Terraform Documentation & Tutorials](https://developer.hashicorp.com/terraform).
