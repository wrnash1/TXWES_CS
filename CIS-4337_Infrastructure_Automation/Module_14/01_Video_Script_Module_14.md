...
*   **Visual:** Instructor on camera with a title card displaying: **Terraform in CI/CD Pipelines**.
*   **Audio:** "Hello class! Today we are digging into a vital topic for the **HashiCorp Certified: Terraform Associate** exam: **Terraform in CI/CD Pipelines**. If you are new to this concept, don't worry. We will break it down step-by-step. Understanding how these systems communicate and operate is fundamental for passing your certification exam and configuring systems in a real-world enterprise environment."
*   **Study Link:** [HashiCorp Terraform Associate Complete Course - Terraform in CI/CD Pipelines](https://www.youtube.com/watch?v=V53S9wB5SgA)

---

### [02:30 - 09:30] Conceptual Deep-Dive
*   **Visual:** Split screen showing slides and a diagram mapping the key configurations.
*   **[Alt-text: A diagram illustrating the operational relationships of Terraform in CI/CD Pipelines components, highlighting data paths and connection rules.]**
*   **Audio:** "Let's review the terms you need to master for this week's unit:
    GitHub Actions, GitLab CI, non-interactive execution (`-auto-approve`), linting/validation.
...
*   **[Alt-text: Command line console output showing the verification runs for Terraform in CI/CD Pipelines.]**
