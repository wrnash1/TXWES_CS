# Lab Activity: Module 14 - Terraform in CI/CD Pipelines
## Course: CIS-4337_Infrastructure_Automation (HashiCorp Certified: Terraform Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Terraform in CI/CD Pipelines**.
...
1. **Write a GitHub Actions YAML workflow file**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Run `terraform validate` in pipeline workflow**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Configure automated plan prints on pull requests**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
