# Lab Activity: Module 01 - IaC Concepts & Benefits
## Course: CIS-4337_Infrastructure_Automation (HashiCorp Certified: Terraform Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **IaC Concepts & Benefits**.
...
1. **Compare manual server provisioning vs automated script configuration**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Review declarative IaC configurations**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Examine infrastructure drift symptoms**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
