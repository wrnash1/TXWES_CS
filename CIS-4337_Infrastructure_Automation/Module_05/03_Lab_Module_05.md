# Lab Activity: Module 05 - Terraform State Management
## Course: CIS-4337_Infrastructure_Automation (HashiCorp Certified: Terraform Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Terraform State Management**.
...
1. **Inspect state file content details: `terraform.tfstate`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Query state registry list: `terraform state list`**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Examine sensitive attributes stored inside state**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
