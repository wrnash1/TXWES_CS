# Lab Activity: Module 07 - Provisioners & Local Exec
## Course: CIS-4337_Infrastructure_Automation (HashiCorp Certified: Terraform Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Provisioners & Local Exec**.
...
1. **Declare a `local-exec` provisioner inside a resource block**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Run a local shell command outputting logs on apply**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Review warnings regarding provisioner dependency risks**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
