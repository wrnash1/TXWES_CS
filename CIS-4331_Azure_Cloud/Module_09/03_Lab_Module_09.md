# Lab Activity: Module 09 - Entra Authentication and MFA
## Course: CIS-4331_Azure_Cloud (Microsoft Azure Fundamentals (AZ-900))

---

## Objective
Configure and verify systems matching the operational parameters of **Entra Authentication and MFA**.
...
1. **Configure a Conditional Access policy requiring MFA for administrators**
