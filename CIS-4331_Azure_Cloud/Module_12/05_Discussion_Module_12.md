# Discussion Forum: Module 12 - Azure Governance & Compliance
...
*   **Topic Focus:** **Azure Governance & Compliance** (specifically focusing on: `Azure Policy, Azure Blueprints, resource tags, locks (ReadOnly, CanNotDelete).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Azure Governance & Compliance in an enterprise system. Address the following:
