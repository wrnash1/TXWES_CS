# Discussion Forum: Module 14 - Azure Cost Management
...
*   **Topic Focus:** **Azure Cost Management** (specifically focusing on: `Pricing calculator, TCO calculator, cost alerts, factors affecting cost, reservations.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Azure Cost Management in an enterprise system. Address the following:
