# Lab Activity: Module 14 - Azure Cost Management
## Course: CIS-4331_Azure_Cloud (Microsoft Azure Fundamentals (AZ-900))

---

## Objective
Configure and verify systems matching the operational parameters of **Azure Cost Management**.
...
1. **Configure a cost budget and warning alert in Azure Cost Management**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Compare price of on-demand vs reserved instances**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Check billing reports**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
