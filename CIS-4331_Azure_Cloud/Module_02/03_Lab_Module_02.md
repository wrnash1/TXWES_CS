...
## Objective
Configure and verify systems matching the operational parameters of **Azure Physical Architecture**.
...
1. **Inspect Azure geography layout**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Create a Resource Group in a specific region**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Review Resource Group lock configurations**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
