# Discussion Forum: Module 10 - Azure RBAC and Subscriptions
...
*   **Topic Focus:** **Azure RBAC and Subscriptions** (specifically focusing on: `Role-Based Access Control (RBAC), built-in roles (Owner, Contributor, Reader), scopes, subscriptions.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Azure RBAC and Subscriptions in an enterprise system. Address the following:
