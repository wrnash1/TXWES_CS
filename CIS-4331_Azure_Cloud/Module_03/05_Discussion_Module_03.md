# Discussion Forum: Module 03 - Azure Virtual Machines & Scale Sets
...
*   **Topic Focus:** **Azure Virtual Machines & Scale Sets** (specifically focusing on: `Azure Compute services, Virtual Machines, Virtual Machine Scale Sets (VMSS), Azure App Services.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Azure Virtual Machines & Scale Sets in an enterprise system. Address the following:
