# Discussion Forum: Module 11 - IT Procurement & Contracts
...
*   **Topic Focus:** **IT Procurement & Contracts** (specifically focusing on: `Request for Proposal (RFP), contract types (Fixed Price, Time & Materials, Cost Reimbursable), SLA terms.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply IT Procurement & Contracts in an enterprise system. Address the following:
