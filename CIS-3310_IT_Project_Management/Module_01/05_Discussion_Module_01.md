# Discussion Forum: Module 01 - IT Project Framework
...
*   **Topic Focus:** **IT Project Framework** (specifically focusing on: `Project vs operations, triple constraint (Scope, Time, Cost), project lifecycle phases.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply IT Project Framework in an enterprise system. Address the following:
