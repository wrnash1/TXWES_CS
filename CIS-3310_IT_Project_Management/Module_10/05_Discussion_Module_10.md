# Discussion Forum: Module 10 - Risk Identification & Management
...
*   **Topic Focus:** **Risk Identification & Management** (specifically focusing on: `Risk register, qualitative risk analysis (probability vs impact), risk response strategies (avoid, transfer, mitigate, accept).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Risk Identification & Management in an enterprise system. Address the following:
