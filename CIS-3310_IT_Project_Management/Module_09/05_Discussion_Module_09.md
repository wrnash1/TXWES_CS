# Discussion Forum: Module 09 - Communication & Stakeholder Management
...
*   **Topic Focus:** **Communication & Stakeholder Management** (specifically focusing on: `Communication channels formula (N*(N-1)/2), communication plan parameters, stakeholder registers.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Communication & Stakeholder Management in an enterprise system. Address the following:
