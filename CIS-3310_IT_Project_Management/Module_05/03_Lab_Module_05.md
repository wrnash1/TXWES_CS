# Lab Activity: Module 05 - Critical Path Method
## Course: CIS-3310_IT_Project_Management (CompTIA Project+ / PMI CAPM)

---

## Objective
Configure and verify systems matching the operational parameters of **Critical Path Method**.
...
1. **Calculate ES/EF and LS/LF for a network diagram**
