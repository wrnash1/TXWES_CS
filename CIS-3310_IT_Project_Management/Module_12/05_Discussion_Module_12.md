# Discussion Forum: Module 12 - Agile Project Management Overview
...
*   **Topic Focus:** **Agile Project Management Overview** (specifically focusing on: `Agile methodologies, sprint cycles, Kanban boards, velocity metrics, adaptive planning.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Agile Project Management Overview in an enterprise system. Address the following:
