# Lab Activity: Module 01 - Server Core
...
**Deliverable:** Take a screenshot of your `sconfig` screen showing the new Computer Name and Static IP address. Submit to Canvas.
