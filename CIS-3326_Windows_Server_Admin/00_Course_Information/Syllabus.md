...
### Course Syllabus: CIS-3326_Windows_Server_Admin - Microsoft Windows Server Administration (Active Directory)
...
### Course Description
This course covers Active Directory Domain Services, Group Policies, DNS/DHCP, IIS web server, and Windows Server storage and clustering.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **Microsoft Windows Server Administration (Active Directory)** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **Microsoft Windows Server Administration (Active Directory)** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [Microsoft Learn: Windows Server Installation and Administration Guides](https://learn.microsoft.com/en-us/windows-server/)
    *   **Primary Video Lecture Course:** [Windows Server Administration Course](https://www.youtube.com/playlist?list=PLvG40H4sL3h0n72gQJ_m8N7xN61tL6d5H)
    *   **Official Vendor Reference Portal:** [Microsoft Learn Server Administration Paths](https://learn.microsoft.com/en-us/windows-server/)
...
*   **Module 01:** Server Core
*   **Module 02:** AD DS
*   **Module 03:** GPOs
*   **Module 04:** File Services
*   **Module 05:** DNS/DHCP
*   **Module 06:** IIS
*   **Module 07:** RDS
*   **Module 08:** Backups
...
*   **Module 12:** NPS/RADIUS
*   **Module 13:** Containers
*   **Module 14:** Clustering
*   **Module 15:** PowerShell
*   **Module 16:** Final Exam Prep & Certification Exam (Microsoft Windows Server Administration (Active Directory))
