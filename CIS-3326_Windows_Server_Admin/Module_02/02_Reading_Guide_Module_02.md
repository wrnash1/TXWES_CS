...
*   **Study Resource**: To reinforce these concepts visually, review this targeted search query: [Windows Server Administration Course - AD DS](https://www.youtube.com/playlist?list=PLvG40H4sL3h0n72gQJ_m8N7xN61tL6d5H).
...
*   **Required Reading:** Read the section/chapter covering **AD DS** in the OER Textbook: [Microsoft Learn: Windows Server Installation and Administration Guides](https://learn.microsoft.com/en-us/windows-server/).
*   **Required Video:** Watch the video lecture on **AD DS** in the official course playlist: [Windows Server Administration Course](https://www.youtube.com/playlist?list=PLvG40H4sL3h0n72gQJ_m8N7xN61tL6d5H).
...
- [ ] Read the section/chapter covering **AD DS** in [Microsoft Learn: Windows Server Installation and Administration Guides](https://learn.microsoft.com/en-us/windows-server/).
- [ ] Watch the video lecture on **AD DS** in [Windows Server Administration Course](https://www.youtube.com/playlist?list=PLvG40H4sL3h0n72gQJ_m8N7xN61tL6d5H).
