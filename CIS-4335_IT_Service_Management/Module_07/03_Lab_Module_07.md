# Lab Activity: Module 07 - The ITIL Guiding Principles
## Course: CIS-4335_IT_Service_Management (ITIL 4 Foundation)

---

## Objective
Configure and verify systems matching the operational parameters of **The ITIL Guiding Principles**.
...
1. **Apply guiding principles to a failed IT rollout scenario**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Analyze system dependencies**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Design automation scripts**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
