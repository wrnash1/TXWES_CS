# Discussion Forum: Module 11 - Practices: Service Desk & Request Management
...
*   **Topic Focus:** **Practices: Service Desk & Request Management** (specifically focusing on: `Service Desk channels, service requests vs incidents, request fulfillment pipelines.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Practices: Service Desk & Request Management in an enterprise system. Address the following:
