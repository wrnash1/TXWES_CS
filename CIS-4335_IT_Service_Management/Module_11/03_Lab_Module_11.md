# Lab Activity: Module 11 - Practices: Service Desk & Request Management
## Course: CIS-4335_IT_Service_Management (ITIL 4 Foundation)

---

## Objective
Configure and verify systems matching the operational parameters of **Practices: Service Desk & Request Management**.
...
1. **Configure request categories in a mock service desk platform**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Assign request tickets to fulfillment queues**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Draft email notification templates**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
