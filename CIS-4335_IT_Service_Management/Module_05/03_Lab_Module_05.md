# Lab Activity: Module 05 - The Service Value System (SVS)
## Course: CIS-4335_IT_Service_Management (ITIL 4 Foundation)

---

## Objective
Configure and verify systems matching the operational parameters of **The Service Value System (SVS)**.
...
1. **Draw the Service Value System block diagram**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Trace opportunities from input to value output**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Map governance checks**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
