# Lab Activity: Module 04 - The Four Dimensions of ITSM
## Course: CIS-4335_IT_Service_Management (ITIL 4 Foundation)

---

## Objective
Configure and verify systems matching the operational parameters of **The Four Dimensions of ITSM**.
...
1. **Map a case study failure to one of the four dimensions**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Examine critical suppliers relationships**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Define workflow processes for a new release**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
