# Lab Activity: Module 02 - Key Concepts: Value & Co-creation
## Course: CIS-4335_IT_Service_Management (ITIL 4 Foundation)

---

## Objective
Configure and verify systems matching the operational parameters of **Key Concepts: Value & Co-creation**.
...
1. **Classify service characteristics into utility vs warranty**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Identify service providers and consumers in a case study**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Analyze customer value metrics**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
