# Discussion Forum: Module 03 - ERP Selection & Vendor Landscape
...
*   **Topic Focus:** **ERP Selection & Vendor Landscape** (specifically focusing on: `ERP vendors (SAP, Oracle, Microsoft Dynamics), selection criteria, total cost of ownership (TCO), RFP processes.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply ERP Selection & Vendor Landscape in an enterprise system. Address the following:
