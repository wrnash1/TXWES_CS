...
### Course Syllabus: CIS-4345_Machine_Learning_Deep_Learning - TensorFlow Developer Certificate
...
### Course Description
ML pipelines, regression models, classification performance, SVM, random forests, dimensionality reduction, neural networks, CNNs, LSTMs, and model serving.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **TensorFlow Developer Certificate** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **TensorFlow Developer Certificate** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [Scikit-Learn User Guide & Keras Documentation](https://scikit-learn.org/stable/user_guide.html)
    *   **Primary Video Lecture Course:** [Machine Learning with Python & TensorFlow Course](https://www.youtube.com/watch?v=cKzgMFG5HpU)
    *   **Official Vendor Reference Portal:** [TensorFlow Core Documentation API Library](https://www.tensorflow.org/)
...
*   **Module 01:** Introduction to ML Pipelines
*   **Module 02:** Linear Regression
*   **Module 03:** Logistic Regression
*   **Module 04:** Regularization Techniques
*   **Module 05:** Support Vector Machines
*   **Module 06:** Decision Trees & Random Forests
*   **Module 07:** K-Means & Hierarchical Clustering
*   **Module 08:** Dimensionality Reduction (PCA)
*   **Module 09:** Introduction to Neural Networks
*   **Module 10:** Activation & Backpropagation
*   **Module 11:** Convolutional Neural Networks
*   **Module 12:** Recurrent Neural Networks (RNN/LSTM)
*   **Module 13:** Natural Language Processing
*   **Module 14:** Model Optimization & Tuning
*   **Module 15:** Model Deployment & Serving
*   **Module 16:** Final Exam Prep & Certification Exam (TensorFlow Developer Certificate)
