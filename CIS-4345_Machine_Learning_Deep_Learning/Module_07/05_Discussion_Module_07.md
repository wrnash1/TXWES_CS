# Discussion Forum: Module 07 - K-Means & Hierarchical Clustering
...
*   **Topic Focus:** **K-Means & Hierarchical Clustering** (specifically focusing on: `Unsupervised learning, centroids, inertia, elbow method, dendrogram structures.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply K-Means & Hierarchical Clustering in an enterprise system. Address the following:
