# Lab Activity: Module 02 - Amazon EC2 Compute Instances
## Course: CIS-4334_AWS_Cloud_Architecture (AWS Certified Solutions Architect - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Amazon EC2 Compute Instances**.
...
1. **Provision an EC2 Linux instance using AMI template**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Configure security keys for SSH authentication**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Verify system ping connectivity**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
