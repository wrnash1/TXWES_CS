# Lab Activity: Module 15 - Well-Architected Framework
## Course: CIS-4334_AWS_Cloud_Architecture (AWS Certified Solutions Architect - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Well-Architected Framework**.
...
1. **Audit system architectures against the 6 pillars framework**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Identify security improvement targets**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Optimize instance types to reduce cost**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
