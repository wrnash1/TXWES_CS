# Lab Activity: Module 12 - Serverless Implementations
## Course: CIS-4334_AWS_Cloud_Architecture (AWS Certified Solutions Architect - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Serverless Implementations**.
...
1. **Write a basic python AWS Lambda function triggered by S3 uploads**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
2. **Configure SQS message queue definitions**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
3. **Publish alerts to SNS topic**
   * *Instruction:* Execute this step inside your terminal environment. Verify the command completes without errors.
