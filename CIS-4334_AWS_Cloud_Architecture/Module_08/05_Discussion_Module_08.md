# Discussion Forum: Module 08 - Amazon RDS and DynamoDB
...
*   **Topic Focus:** **Amazon RDS and DynamoDB** (specifically focusing on: `Relational Database Service (RDS), database engines, DynamoDB NoSQL key-value store.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Amazon RDS and DynamoDB in an enterprise system. Address the following:
