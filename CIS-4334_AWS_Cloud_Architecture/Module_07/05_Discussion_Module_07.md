# Discussion Forum: Module 07 - Amazon EBS & EFS Storage Systems
...
*   **Topic Focus:** **Amazon EBS & EFS Storage Systems** (specifically focusing on: `EBS volume types (SSD, HDD), EFS (multi-instance mount), instance store (ephemeral).`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply Amazon EBS & EFS Storage Systems in an enterprise system. Address the following:
