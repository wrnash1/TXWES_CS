...
*   **Topic Focus:** **RESTful API Principles** (specifically focusing on: `Representational State Transfer (REST), endpoints, resource identifiers, HTTP verbs, status codes.`)

**Your Tasks:**
1.  **Initial Post (Due Wednesday at 11:59 PM):** In 150-200 words, explain how you would apply RESTful API Principles in an enterprise system. Address the following:
