...
### Course Syllabus: CIS-3340_Full_Stack_Web_Dev - AWS Certified Developer - Associate
...
### Course Description
HTML5, CSS layouts, asynchronous JavaScript, REST APIs, Express servers, databases, React hooks, JWT security, and AWS EC2/S3 cloud deployment.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **AWS Certified Developer - Associate** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **AWS Certified Developer - Associate** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [Full Stack Open by University of Helsinki](https://fullstackopen.com/en/)
    *   **Primary Video Lecture Course:** [Full Stack Web Development Course by freeCodeCamp](https://www.youtube.com/watch?v=nu_pCVPKzTk)
    *   **Official Vendor Reference Portal:** [AWS Developer Documentation Portal](https://aws.amazon.com/developer/)
...
*   **Module 10:** NoSQL Databases with MongoDB
*   **Module 11:** Frontend Frameworks (React)
*   **Module 12:** React State & Props
*   **Module 13:** Web Security (JWT & CORS)
*   **Module 14:** Deployment to AWS
*   **Module 15:** Web Sockets
*   **Module 16:** Final Exam Prep & Certification Exam (AWS Certified Developer - Associate)
