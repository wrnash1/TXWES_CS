# Lab Activity: Module 10 - NoSQL Databases with MongoDB
## Course: CIS-3340_Full_Stack_Web_Dev (AWS Certified Developer - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **NoSQL Databases with MongoDB**.
...
1. **Establish a mongoose server connection profile**
