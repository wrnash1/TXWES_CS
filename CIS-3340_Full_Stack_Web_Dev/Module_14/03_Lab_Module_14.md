# Lab Activity: Module 14 - Deployment to AWS
## Course: CIS-3340_Full_Stack_Web_Dev (AWS Certified Developer - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Deployment to AWS**.
...
1. **Deploy static build files to AWS S3 bucket**
