# Lab Activity: Module 13 - Web Security (JWT & CORS)
## Course: CIS-3340_Full_Stack_Web_Dev (AWS Certified Developer - Associate)

---

## Objective
Configure and verify systems matching the operational parameters of **Web Security (JWT & CORS)**.
...
1. **Configure CORS origins in Express app**
