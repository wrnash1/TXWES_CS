...
### Course Description
This course covers network administration, focusing on the OSI model, IP addressing, routing, switching, wireless technologies, and network security.

### Course Objectives / Student Learning Outcomes
By the end of this course, students will be able to:
1. Explain and configure core principles of **CompTIA Network+ (N10-008)** in a variety of business and technical scenarios.
...
4. Prepare for and demonstrate competency aligned with the official **CompTIA Network+ (N10-008)** certification exam blueprint.
...
*   **Primary OER Resources:**
    *   **Primary Open Textbook:** [Computer Networking: Principles, Protocols and Practice](https://www.computer-networking.info/)
    *   **Primary Video Lecture Course:** [Professor Messer's CompTIA Network+ Course Playlist](https://www.youtube.com/playlist?list=PLG49S3nxzAnmpm1HP80g85VIyFCxs34ee)
    *   **Official Vendor Reference Portal:** [CompTIA Network+ Standards Documentation](https://www.comptia.org/)
