...
*   **Study Resource**: To reinforce these concepts visually, review this targeted search query: [Professor Messer's CompTIA Network+ Course Playlist - VLANs](https://www.youtube.com/playlist?list=PLG49S3nxzAnmpm1HP80g85VIyFCxs34ee).
...
*   **Required Reading:** Read the section/chapter covering **VLANs** in the OER Textbook: [Computer Networking: Principles, Protocols and Practice](https://www.computer-networking.info/).
*   **Required Video:** Watch the video lecture on **VLANs** in the official course playlist: [Professor Messer's CompTIA Network+ Course Playlist](https://www.youtube.com/playlist?list=PLG49S3nxzAnmpm1HP80g85VIyFCxs34ee).
...
- [ ] Read the section/chapter covering **VLANs** in [Computer Networking: Principles, Protocols and Practice](https://www.computer-networking.info/).
- [ ] Watch the video lecture on **VLANs** in [Professor Messer's CompTIA Network+ Course Playlist](https://www.youtube.com/playlist?list=PLG49S3nxzAnmpm1HP80g85VIyFCxs34ee).
