# Lab Activity: Module 04 - Security
...
**Deliverable:** Take a screenshot of the output of `sudo ufw status verbose` showing the active rules for SSH (allowed) and Port 80 (denied). Submit to Canvas.
