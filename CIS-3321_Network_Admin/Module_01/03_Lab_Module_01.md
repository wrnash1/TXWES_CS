# Lab Activity: Module 01 - OSI Model
...
## Deliverable
Take a screenshot of the successful `ping` command from VM_1, ensuring the IP addresses of both machines are visible in your terminal window. Submit this screenshot to the Canvas assignment drop-box.
